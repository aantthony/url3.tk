...
return mathquill;
}(jQuery));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('w 7q="ma";w g=[];w E=L(x,y,dx,dy){J g[0](x)};w 4l=1k;w 4w=1k;w c=m9;w G=6.m8-11;w 7v=5.m7;w m6=7.m5;w m4=1.m3;w m2=b6;w 7u=b6;w h=6.m1-34;w aO=1.m0;w e=1d.E;w 1G=1d.2K;w 4L=(1+1d.1S(5))/2;w lZ=8.lY-12;w en=["lX 61","lW","lV","lU","lT","lS","lR","lQ","lP","lO","lN","lM","lL","lK","lJ","lI","lH","lG","lF","lE","lD","lC","lB","lA","lz","lw","lv","lu","lr","lq","lp","lo","lm","ll","lk","lj","lh","lg","lf","ld","lc","lb","la","l9","l8","l7","l6","l5","l4","l3","l2","l1","l0","kZ","kY","kX","kW","kV","kU","kT","kS","kR","kQ","kP","kO","kN","kM","kL","kK","kJ","kI","kH","kG","kF","kE","kD","kC","kB","kA","kz","ky","kx","kw","kv","ku","kt","ks","kr","kq","kp","ko","kn","km","kl","kk","kj","ki","kh","kg","kf","ke","kd","kc","kb","ka","k9","k8","k7","k6","k5","k4","k3"];w M=[0.0,1.k2,4.k1,6.k0,9.jZ,10.jY,12.jX,14.jW,15.b5,18.b5,20.jV,22.jU,24.jT,26.jS,28.jR,30.jQ,32.jP,35.jO,39.jN,39.jM,40.jL,44.jK,47.jJ,50.jI,51.jH,54.jG,55.jF,58.jE,58.jD,63.jC,65.38,69.jB,72.64,74.jA,78.96,79.jz,83.jy,85.jx,87.62,88.jw,91.jv,92.ju,95.96,98,jt.js,jr.jq,jp.42,jo.jn,jm.jl,jk.jj,ji.71,jh.76,jg.6,jf.je,jd.jc,jb.ja,j9.j8,j7.j6,b4.j5,b4.j4,j3.j2,j1,j0.36,iZ.iY,iX.25,iW.iV,iU.iT,iS.iR,iQ.aZ,iP.iO,iN.iM,iL.iK,iJ.49,iI.iH,iG.84,iF.b2,iE.23,b3.iD,b3.iC,iB.iA,iz.59,iw.iv,b2.2,iu.ir,b1,b1,iq,ip,io,im,il.ik,ij.ii,ih.ig,ie,ic,ib,b0,b0,i9,i8,i7,i6,aZ,aY,i5,aY,i4,i3,i2,i1,i0,hZ];w 66=["hY","H","hX","hW","hV","B","C","N","O","F","hU","hT","hS","hR","hQ","P","S","hP","hO","K","hN","hM","hL","V","hK","hJ","ar","hI","hH","hG","hF","hE","hD","hC","hB","hA","hz","hy","hx","Y","hw","hv","hu","aX","ht","hs","hr","hq","hp","ho","hn","hm","aX","I","hl","hk","hj","hi","hh","hg","hf","he","hd","hc","hb","ha","h9","h8","h7","h6","h5","h4","h3","h2","W","h0","gZ","gY","gX","gW","gV","gU","gT","gS","gR","gQ","gP","gO","gN","gM","gL","gK","U","gJ","gI","gH","gG","gF","gE","gD","gC","gB","gA","gz","gx","gw","gv","gu","gs","gr","gq","gp"];1j(w 3a=0;3a<66.1c;3a++){1h[66[3a]]=M[3a]}w 1A=1d.1A;w 33=1d.33;w 2m=1d.2m;w 6Y=1d.2m;w 2a=1d.2a;w 1X=1d.1X;w ln=1d.1X;w 2h=1d.2h;w aW=1d.aW;w aV=1d.aV;w 70=1d.70;w aU=1d.aU;w 5K=1d.5K;w 5L=1d.5L;w aT=1d.aT;w aS=1d.aS;w aR=1d.aR;w 3n=1d.3n;w 1S=1d.1S;w Q=1d.Q;L go(n,x){J Q(1A(x),n)}L gn(n,x){J Q(33(x),n)}L gm(n,x){J Q(2m(x),n)}L gl(n,x){J Q(3r(x),n)}L gk(n,x){J Q(46(x),n)}L gj(n,x){J Q(45(x),n)}L gi(n,x){J Q(1X(x),n)}L gh(n,x){J Q(ln(x),n)}L 77(b,v){J ln(v)/ln(b)}L u(x){J(x>=0)?(x?1:0.5):(0)}L gg(x){J 2*u(x)-1}L gf(aQ,1I,aP){if(aQ){J 1I}J aP}L gd(x){if(x===0){J 1}J 1A(1G*x)/(1G*x)}L 46(x){J 1/(33(x))}L 45(x){J 1/(1A(x))}L gc(x){J 1/(1A(x))}L 3r(x){J 1/(2m(x))}w gb=3r;w ga=3r;w 7A=[1,1,2,5,15,52,g9,g8,g7,g6,g5,g4,g3,g2,g1,g0,fZ,fY,fX,fW,fV,fU,fT];L 3K(x){if(x===0){J-0.5}19 if(x==1){J 1V}19 if(x==2){J 1G*1G/6}19 if(x==4){J 1G*1G*1G*1G/90}19 if(x<1){J 1V}w 3t=4.4*Q(x,-5.1);1j(w 6i=1;6i<10;6i++){3t+=Q(6i,-x)}J 3t}L 43(x){if(x>1.0){J(2a(x*(ln(x)-1)+0.5*(-ln(x)+aO)+1/ (12 * x) - 1 /(fS*(x*x*x))+1/ (fR * Q(x, 5)) - 1 /(fQ*Q(x,7))))}if(x>-0.5){J(1.0+0.fP*x+0.fO*Q(x,2))/(x+0.fN*Q(x,2)-0.fM*Q(x,3))}if(x<0){if(x==~~x){J}19{J 1d.2K/(1d.1A(1d.2K*x)*43((1-x)))}}19{J Q(x-1,x-1)*1d.1S(2*1d.2K*(x-1))*2a(1-x+1/ (12 * (x - 1) + 2 /(5*(x-1)+53/(42*(x-1)))))}}L 1p(ff){if(ff===0||ff==1){J 1}19 if(ff>0&&ff==~~ff&&ff<15){w s=1;1j(w 6h=1;6h<=ff;6h++){s*=6h}J~~s}19 if(ff!=(~~ff)||ff<0){J 43(ff+1)}}L 5N(x){if(x==~~x&&x<7A.1c){J 7A[x]}19{w 3t=0;1j(w 5b=0;5b<5;5b++){3t+=Q(5b,x)/1p(5b)}J 3t/e}}L 9B(7z,7y){if(7y===2b){J 7z}J{"x":7z,"y":7y}}L 1l(ia,6g,x){4h++;w 5a;if(4h>8){4h-=1;J 0}w h=0.fL;if(6g>0){5a=(1l(ia,6g-1,x+h)-1l(ia,6g-1,x-h))/(2*h);4h-=1;J 5a}5a=g[ia](x);4h-=1;J 5a}w 4h=0;w 6j=1k;w 3j=0;w 1U=0;w D;w 3Q=/fK/.1F(1h.3h.3g);w 1Q="2s";if(1h.5c.1c){1Q="2P"}if(3Q){1Q="2P"}w 4C=-10;w 3W=10;w 1M=10;w 1T=-10;L 6T(n){if(1h.aN){5v(L(){aN.fJ("fI",n)},20)}};L 2i(29,2R){if(!3z(2R)){if(2R>1M+2){D.7x(29,-1M-2);J}19 if(2R<1T-2){D.7x(29,-1T+2);J}D.7x(29,-2R)}}L 1L(29,2R){if(!3z(2R)){if(2R>1M+2){D.7w(29,-1M-2);J}19 if(2R<1T-2){D.7w(29,-1T+2);J}D.7w(29,-2R)}}w aM="⋅";if(/fH/.1F(3h.3g)&&/7s/.1F(3h.3g)){aM="∙"}L 1K(z){w 6f="7i,1b,1h,3I,fG,6s,fF,fE,1m,5c,fD,fC,fB,fz,1z,6O,6N,2L,6M,5A,1o".5S(",");1j(w 57=0;57<6f.1c;57++){if(z.48(6f[57])!=-1){5H("fy fw: "+6f[57])}}J 7i(z)}w 6d="x^2~f\'(x)-1~2e^-x~2x+3~{λ:λ=3}~e^(-λ*x)~(0.5,0.5)~∑[1...∞,1A(5g)/n]~m:aL~|x^2-4|+2~1/x~x^-2~x!~fv~∑[1,6e,(x^n)/n!]~fu~e^x:[−2,2]~2m(x)~(x+2)(x-3)^2~73(0,2,2x)~(x-2)^2~∑[1,∞,1A((2n−1)x)/(2n−1)]~~∏[1,5,(x-n)]~∑[0,5,n]~x^x~6W(x)~(x!)/(3!-x)~x%3~(x>3)?2x:-3~1p(x)~4L/x~(x>=0)?7v*G/(7u+aJ)^2:2b~g[0]\'(2x)~g[0](x)+1~1S(x)".5S("~");if(1Q=="2s"){6d="x^2    f\'\\\\1f(x\\\\1e)-1    2e^{-x}    2x+3    \\\\5I=3    e^{-\\\\5I*x}    \\\\1f(0.5,0.5\\\\1e)    \\\\4o{n=1}^{\\\\6e}\\\\3d{\\\\1A\\\\1f(5g\\\\1e)}n    \\\\aK{1}^{4}x-n    m:aL    \\\\1f|x^2-4\\\\1e|+2    \\\\ft    x^{-2}    x!    \\\\ln x    \\\\4o{n=1}^{\\\\6e}\\\\3d{x^n}{n}    \\\\1A x    e^x:\\\\1f[−2,2\\\\1e]    \\\\2m\\\\1f(x\\\\1e)    \\\\1f(x+2\\\\1e)\\\\1f(x-3\\\\1e)^2    73\\\\1f(0,2,2x\\\\1e)    \\\\1f(x-2\\\\1e)^2    \\\\4o{n=1}^{\\\\6e}\\\\3d{\\\\1A\\\\1f(\\\\1f(2n−1\\\\1e)x\\\\1e)}{2n−1}    \\\\aK{n=1}^5\\\\1f(x-n\\\\1e)    \\\\4o{n=0}^5n    x^x    \\\\43\\\\1f(x\\\\1e)    \\\\3d{x!}{3!-x}    x%3    \\\\1f(x>3\\\\1e)?2x:-3    \\\\1p\\\\1f(x\\\\1e)    \\\\3d\\\\4L x    \\\\1f(x>=0\\\\1e)?7v*G/\\\\1f(7u+aJ\\\\1e)^2:2b    g\\\\1f[0\\\\1e]\'\\\\1f(2x\\\\1e)    g\\\\1f[0\\\\1e]\\\\1f(x\\\\1e)+1    \\\\1S x".5S("    ");}w aI=0;L 7b(){J 6d[(aI++)%6d.1c]}if(1h.3I.6c!=""){1h.7S=1k;if(1h.3I.6c[2]=="="){1h.80=1h.3I.6c.6X(3)}19{1h.6r=fs(1h.3I.6c.6X(6))}}w 4n=1b.1n("4n");4n.6l="<56 1a=\\"1J:1P\\" 4v=\\"6F.8n\\" 1t=\\"16\\" 1B=\\"16\\"><1o id=\\"1o\\" 1B=\\"fr\\" 1t=\\"fq\\"><1u 1a=\\"60:fp;2J-az:4A-4z\\"><h1>7e</h1>fo fm fl is as fk fj 1j 1m!. <a 1H=\\"5h\\">fi 1m fh.</a><br />fg 7t 5k, 5m 7p 5l<br><br>fe aH 7m 7Y fd, 7p fc fb aH.<br><br><a 1H=\\"2r://3c.7t.2Q/5k/\\"><56 id=\\"82\\" 6b=\\"aG 6A\\"></a>&4X;<a 1H=\\"2r://3c.7t.2Q/5k/\\">6a aG 6A</a><br><a 1H=\\"2r://3c.aF.2Q/5m\\"><56 id=\\"8a\\" 6b=\\"6C\\"></a>&4X;<a 1H=\\"2r://3c.aF.2Q/5m\\">6a 6C</a><br><a 1H=\\"2r://3c.aE.2Q/5l\\"><56 id=\\"89\\" 6b=\\"7s\\"></a>&4X;<a 1H=\\"2r://3c.aE.2Q/5l\\">6a 7s</a><br><a 1H=\\"2r://3c.6x.2Q/aD/\\"><56 fa=\\"f9\\" id=\\"86\\" 6b=\\"6B\\"></a>&4X;<a 1H=\\"2r://3c.6x.2Q/aD/\\">6a 6B</a><br></1u></1o><1u id=\\"2u\\" 1a=\\"f8:f7;z-f6:f5;f4:2H;2S:0.6;1f:4Y;ap:4Y;f3:1P;2M:3X;-f2-68:2S 0.5s 67-in-4b;-f1-68:2S 0.5s 67-in-4b;-o-68:2S 0.5s 67-in-4b;68: 2S 0.5s 67-in-4b;2J:f0 \'eZ\',\'eY 7r\',\'eX\',\'eW aC 7r\',\'eV aC 7r\',\'eU 6S\',\'eT\',\'eS\',eR\\">(0,0)</1u><1u id=\\"41\\" 1a=\\"1J:1P\\" 3u=\\"3C\\"><1u id=\\"31\\"><1u>4e.1w eQ.2 (<a 1H=\\"eP://aB.2Q/aA/4e.1w/eO/"+7q+"\\">"+7q+"</a>) &eN; eM eL<br /><br />7n: <a 1H=\\"2r://3c.eK.eJ/eI/eH.eG\\" eF=\\"7o ay ax aw 7n\\" 7l=\\"7k\\">7o eD</a><br />eC eB: <a 1H=\\"2r://aB.2Q/aA/4e.1w\\" 7l=\\"7k\\">4e.1w 8j eA</a><br /><1u 1a=\\"2J-az:4A-4z;2J-3J:x-4f\\">ez ey is ew in 4g ev at it av be eu, au et es er; eq ep 4g eo em 7m el 7p ek ej A ei eh. eg 4g 7o ay ax aw 7n 1j ef ee.<br /><br>ed:<br>ec x^n av 9R be x 3P 4g eb 7m n, au x ea n, 4j is 4g e9 4Z e8. I e7 e6 e5 at e4 e3 e2 e1. A e0 dZ 4g dY dX it dW dV in a dU-4Z-dT as. dS 3J() 3P dR 3J.<br></1u><br>dQ dP dO 3P 2O:<br> ar, m:dN, g(0), g[1](0), en[26], M[26], 66[26]</1u></1u><br><2P 2O=\\"2q\\" 1a=\\"1B:dM%\\" id=\\"8H\\" 2g=\\"if(2v.4j==13){8C(1m)};if(2v.4j==38){1m.R=6Q}\\"></1u><1u id=\\"7B\\" 3u=\\"3C\\"><aq 3u=\\"f\\" id=\\"1v\\"><li id=\\"3w\\"><1u 3u=\\"b\\" 1a=\\"2M:#9T\\"></1u><2s 3u=\\"2U\\"></2s><2s 3u=\\"9Z\\" 6w=\\"5C(1m);\\"></2s></li></aq><2P 2O=\\"5Y\\" R=\\"+\\" id=\\"7L\\" 4k=\\"4i();6T(\'dL\')\\"><a 1H=\\"4Z:61(8I())\\" 1a=\\"2J-3J:4f;60:4Y\\" id=\\"7N\\">6S</a><a 1H=\\"4Z:61(6t())\\" 1a=\\"2J-3J:4f;60:4Y\\" id=\\"7M\\">dK dJ</a><a 1H=\\"4Z:61(8L())\\" 1a=\\"2J-3J:4f;60:4Y\\" id=\\"7K\\">dI</a><4f id=\\"6k\\"></4f><1u 1a=\\"dH:1e\\"><a 1H=\\"2r://4e.1w/5h\\" 7l=\\"7k\\"><2P 2O=\\"5Y\\" R=\\"dG\\" 4k=\\"dF=\'2r://4e.1w/5h\'\\"></a></1u></1u><1u id=\\"3C\\" 1a=\\"1J:1P;ap:0;1e:0\\" 3u=\\"3C\\"><ak><al><3x><1O 1a=\\"1B:dE\\"><2P 2O=\\"5Y\\" R=\\"f \' (x)\\" 4k=\\"if(1m.R==\'f \\\\\' (x)\'){1m.R=\'f \\\\\' \\\\\' (x)\';4H=1r;}19{1m.R=\'f \\\\\' (x)\';4H=1k;}\\"> = </1O><1O><2P 2O=\\"2q\\" id=\\"7V\\" R=\\"g(x)\\" 3B=\\"1m.2g()\\" 2g=\\"8x(1m)\\" 5R=\\"1m.2g()\\"></1O></3x><3x><1O>x<5Z>0</5Z> = </1O><1O><2P 2O=\\"2q\\" R=\\"0\\" id=\\"ao\\" 3B=\\"1m.2g()\\" 2g=\\"6V(1m)\\" 5R=\\"1m.2g()\\"></1O></3x><3x><1O>y<5Z>0</5Z> = </1O><1O><2P 2O=\\"2q\\" R=\\"1\\" id=\\"am\\" 3B=\\"1m.2g()\\" 2g=\\"6V(1m)\\" 5R=\\"1m.2g()\\"></1O></3x><3x><1O>&4X;</1O><1O><2P 2O=\\"5Y\\" R=\\"3Y\\" id=\\"3o\\" 4k=\\"if(2j){2j=1k;}19{8u(1b.1n(\'ao\').R,1b.1n(\'am\').R)}\\"></1O></3x></al></ak></1u>";w 2u=1b.1n("2u");w 1o=1b.1n("1o");w 3o=1b.1n("3o");w 3C=1b.1n("3C");w 1B,1t,1z;w 2G=dD;w 2W=dC;w 5t;w 5r;w 1W=1;w dB=1W;w 2V=0;w 3f=0;w ix=1;w iy=1;w 2z=1;w 2k=1;w dx=0;w dy=0;w lx=1;w ly=1;w cx=0;w cy=0;w 2j=1k;w 3p=0.2F;w 41=1b.1n("41");w 7c=1b.1n("3w").9P(1r);7c.dA("id");if(!1m.21){1m.21={}}(L(){L f(n){J n<10?\'0\'+n:n}if(1x aj.3w.3N!==\'L\'){aj.3w.3N=L(3b){J a1(1m.ai())?1m.dz()+\'-\'+f(1m.dw()+1)+\'-\'+f(1m.dv())+\'T\'+f(1m.du())+\':\'+f(1m.dt())+\':\'+f(1m.ds())+\'Z\':1s};5T.3w.3N=dr.3w.3N=dq.3w.3N=L(3b){J 1m.ai()}}w cx=/[\\dp\\ah\\ag-\\af\\ae\\ad\\ac\\ab-\\aa\\a9-\\a8\\a7-\\a6\\a5\\a4-\\a3]/g,5X=/[\\\\\\"\\do-\\dn\\dm-\\dl\\ah\\ag-\\af\\ae\\ad\\ac\\ab-\\aa\\a9-\\a8\\a7-\\a6\\a5\\a4-\\a3]/g,1Y,4U,a2={\'\\b\':\'\\\\b\',\'\\t\':\'\\\\t\',\'\\n\':\'\\\\n\',\'\\f\':\'\\\\f\',\'\\r\':\'\\\\r\',\'"\':\'\\\\"\',\'\\\\\':\'\\\\\\\\\'},3v;L 5W(q){5X.9Y=0;J 5X.1F(q)?\'"\'+q.l(5X,L(a){w c=a2[a];J 1x c===\'q\'?c:\'\\\\u\'+(\'9X\'+a.9W(0).4F(16)).9V(-4)})+\'"\':\'"\'+q+\'"\'}L 4S(3b,4c){w i,k,v,1c,4V=1Y,2A,R=4c[3b];if(R&&1x R===\'3G\'&&1x R.3N===\'L\'){R=R.3N(3b)}if(1x 3v===\'L\'){R=3v.5U(4c,3b,R)}dk(1x R){4W\'q\':J 5W(R);4W\'5e\':J a1(R)?5T(R):\'1s\';4W\'dj\':4W\'1s\':J 5T(R);4W\'3G\':if(!R){J\'1s\'}1Y+=4U;2A=[];if(7j.3w.4F.di(R)===\'[3G 9S]\'){1c=R.1c;1j(i=0;i<1c;i+=1){2A[i]=4S(i,R)||\'1s\'}v=2A.1c===0?\'[]\':1Y?\'[\\n\'+1Y+2A.5V(\',\\n\'+1Y)+\'\\n\'+4V+\']\':\'[\'+2A.5V(\',\')+\']\';1Y=4V;J v}if(3v&&1x 3v===\'3G\'){1c=3v.1c;1j(i=0;i<1c;i+=1){k=3v[i];if(1x k===\'q\'){v=4S(k,R);if(v){2A.2Z(5W(k)+(1Y?\': \':\':\')+v)}}}}19{1j(k in R){if(7j.a0.5U(R,k)){v=4S(k,R);if(v){2A.2Z(5W(k)+(1Y?\': \':\':\')+v)}}}}v=2A.1c===0?\'{}\':1Y?\'{\\n\'+1Y+2A.5V(\',\\n\'+1Y)+\'\\n\'+4V+\'}\':\'{\'+2A.5V(\',\')+\'}\';1Y=4V;J v}}if(1x 21.4J!==\'L\'){21.4J=L(R,4d,4T){w i;1Y=\'\';4U=\'\';if(1x 4T===\'5e\'){1j(i=0;i<4T;i+=1){4U+=\' \'}}19 if(1x 4T===\'q\'){4U=4T}3v=4d;if(4d&&1x 4d!==\'L\'&&(1x 4d!==\'3G\'||1x 4d.1c!==\'5e\')){5H 7f 7e(\'21.4J\')}J 4S(\'\',{\'\':R})}}if(1x 21.4s!==\'L\'){21.4s=L(2q,7h){w j;L 7g(4c,3b){w k,v,R=4c[3b];if(R&&1x R===\'3G\'){1j(k in R){if(7j.a0.5U(R,k)){v=7g(R,k);if(v!==2b){R[k]=v}19{9Z R[k]}}}}J 7h.5U(4c,3b,R)}2q=5T(2q);cx.9Y=0;if(cx.1F(2q)){2q=2q.l(cx,L(a){J\'\\\\u\'+(\'9X\'+a.9W(0).4F(16)).9V(-4)})}if(/^[\\],:{}\\s]*$/.1F(2q.l(/\\\\(?:["\\\\\\/dh]|u[0-9a-fA-F]{4})/g,\'@\').l(/"[^"\\\\\\n\\r]*"|1r|1k|1s|-?\\d+(?:\\.\\d*)?(?:[eE][+\\-]?\\d+)?/g,\']\').l(/(?:^|:|,)(?:\\s*\\[)+/g,\'\'))){j=7i(\'(\'+2q+\')\');J 1x 7h===\'L\'?7g({\'\':j},\'\'):j}5H 7f dg(\'21.4s\')}}}());w 4N="#9U,#de,#dd,#9U,#dc,#db,#d9,#d8,#d7,#d6,#d5,#d4,#d3,#9T".5S(",");w 4D=7f 9S(0);L d2(n){J 4N[n%(4N.1c)]}w 1v=1b.1n("1v");w 31=1b.1n("31");w 4M={\'gt\':">","1f":"","1e":"",\'ge\':">=",\'lt\':"<",\'le\':"<=","7R":"∞","d1":"*","3d":"","9z":"α","9y":"β",\'6W\':"γ",\'9x\':"δ",\'3K\':"ζ",\'9w\':"η",\'5J\':"θ",\'9v\':"ι",\'9u\':"κ",\'9t\':"μ",\'9s\':"ν",\'9r\':"ξ",\'9q\':"ο",\'9p\':"ρ",\'9o\':"σ",\'9n\':"τ",\'9m\':"υ",\'9l\':"χ",\'9k\':"ψ",\'9j\':"ω",\'4L\':"ϕ","9i":"φ","d0":"φ","9h":"ϵ","9g":"ε","cZ":"ε","9f":"ς","cY":"ς","9d":"ϝ","cX":"ϝ","cW":"ϝ","9c":"ϰ","cV":"ϰ","9b":"ϖ","cU":"ϖ","99":"ϱ","cT":"ϱ","97":"ϑ","cS":"ϑ","1G":"π","5I":"λ",\'43\':"Γ",\'94\':"Δ",\'93\':"Θ",\'8Z\':"Λ",\'8Y\':"Ξ",\'8X\':"Π",\'8W\':"Σ",\'8V\':"Υ",\'8U\':"Φ",\'8T\':"Ψ",\'8S\':"Ω","8R":"⊥",",":" ","8Q":"∇","8P":"∀","3t":"∑","cR":"∑","cQ":"∏","cP":"∏","8O":"∐","cO":"∐","8N":"∫","cN":"∫"};L 9Q(cM,4R){if(4R==",")J"";if(4M[4R]!==2b)J 4M[4R];J 4R}L 4r(1i,4Q){if(1i.cL("3u")=="2U"){4I("7e: 2U is 9R a 3A","8t")}if(1Q=="2s"){if(4Q)J $(1i).3A("4Q");J($(1i).3A("4Q").l(/}{/g,")/(").l(/\\\\([a-9F-Z\\.\\,]+)/g,9Q).l(/{/g,"(").l(/}/g,")").l(/\\\\/g,""))}19{J 1i.R}}L 7U(1i,1I){if(1Q=="2s"){$(1i).3A("4Q",1I)}19{1i.R=1I}}L 3H(){if(!4l){J}if(1h.4t){w 7d={"5d":"6q",g:[]};1j(w n=0;n<1v.2t.1c;n++){7d.g.2Z(4r(1v.2t[n].3e("2U")[0].4q(1Q)[0],1r))}w 4b=21.4J(7d);1h.4t.7W("fn",4b)}}L 4i(5Q){w 4P=7c.9P(1r);w 2p=1b.5F(1Q);w 9O=4P.3e("2U")[0];9O.3q(2p);if(1Q=="2s"){2p.3q(1b.6R(5Q||7b()));$(2p).3A(\'cK\')}19{2p.R=5Q||7b();2p.2g=2p.5R=L(){1m.3B()}}g.2Z(L(x){J 0});w 9N=1v.2t.1c;2p.3B=L(){8z(2b,9N)};if(4P.3e){w bs=4P.3e("b");4D.2Z(4N.9M());if(bs.1c>0){bs[0].1a.2M=4D[1v.2t.1c]}}1v.3q(4P);if(1Q=="2s"){$(2p).3A("7Q");if(!5Q){$(2p).cJ({2O:"cI",cH:1r,4j:65})}}19{2p.3B()}if(6j){2p.6U();3H();1z()}}L 5C(){if(1v.2t.1c>1){g.9M();1v.6v(1v.9L);1v.9L.3e("2U")[0].4q(1Q)[0].6U();3H()}}L 5C(9K){7a=9K.cG;3a=0;4O=1v.81;8m(4O!=1s){if(4O==7a){7D;3a++}4O=4O.cF}g.9J(3a,1);4N.2Z(4D.9J(3a,1)[0]);1v.6v(7a);3H()};w 4H=1k;L 2L(q,5M){q=q.l(/\\^\\(\\)/g,"");q=q.l(/X/g,"x");q=q.l(/ /g,"");q=q.l(/√/g,"1S");q=q.l(/[•⋅∙]/g,"*");q=q.l(/[9I]cE/g,"∞");q=q.l(/[9I]cD/g,"∞");q=q.l(/⁻ⁱ/g,"^-1").l(/ⁿ/g,"^n").l(/⁻²/g,"^-2").l(/⁻?⁰/g,"^0").l(/⁻³/g,"^-3").l(/⁻⁴/g,"^-4").l(/⁻⁵/g,"^-5").l(/⁻⁶/g,"^-6").l(/⁻⁷/g,"^-7").l(/⁻⁸/g,"^-8").l(/⁻⁹/g,"^-9");q=q.l(/(1A|33|2m)\\^\\(\\-1\\)/g,"a$1");q=q.l(/(1A|33|2m|46|45|3r|1X|ln)\\^([\\5P])\\(/g,"$9H($2,");q=q.l(/(1A|33|2m|46|45|3r|1X|ln)\\^([\\5P])([^\\(])/g,"$9H($2,$3)");q=q.l(/9G([\\5P])\\(/g,"77($1,");q=q.l(/9G([\\5P])([^\\(])/g,"77($1,$2)");1j(i in 4M){if(i.1c>1){q=q.l(i,4M[i])}}q=q.l(/(∑|∏)([^\\[^\\3s^\\^^\\{][^\\[]*)$/,"$1[1,∞,$2]");q=q.l(/(∑|∏)3s\\(([^\\)]+)\\)\\^\\(([^\\)]+)\\)(.+)$/,"$1[$2,$3,$4]");q=q.l(/(∑|∏)3s([\\d]+|.)\\^([\\d]+|.)(.+)$/,"$1[$2,$3,$4]");q=q.l(/(∑|∏)3s\\(([^\\)]+)\\)\\^([\\d]+|.)(.+)$/,"$1[$2,$3,$4]");q=q.l(/(∑|∏)3s([\\d]+|.)\\^\\(([^\\)]+)\\)(.+)$/,"$1[$2,$3,$4]");q=q.l(/[÷∕⁄]/g,"/").l(/−/g,"-").l(/′/g,"\'").l(/3t/g,"∑").l(/¼/g,"0.25").l(/½/g,"0.5").l(/¾/g,"0.75").l(/⅓/g,"(1/3)").l(/⅔/g,"(2/3)").l(/⅕/g,"0.2").l(/⅖/g,"0.4").l(/⅗/g,"0.6").l(/⅘/g,"0.8").l(/⅙/g,"(1/6)").l(/⅚/g,"(5/6)").l(/⅛/g,"0.cC").l(/⅜/g,"0.cB").l(/⅝/g,"0.cA").l(/⅞/g,"0.cz").l(/5g/g,"n*x").l(/73\\(/g,"1l(");if(5M===1r){q=q.l(/[2o]\'\\[([\\d]+)\\]\\(/g,"1l($1,1,");q=q.l(/[2o]\\[([\\d]+)\\]\'\\(/g,"1l($1,1,");q=q.l(/[2o]\'\\(/g,"1l(0,1,");q=q.l(/[2o](\'\'|")\\[([\\d]+)\\]\\(/g,"1l($2,2,");q=q.l(/[2o]\\[([\\d]+)\\](\'\'|")\\(/g,"1l($1,2,");q=q.l(/[2o](\'\'|")\\(/g,"1l(0,2,");q=q.l(/[2o]\'\'\'\\[([\\d]+)\\]\\(/g,"1l($1,3,");q=q.l(/[2o]\\[([\\d]+)\\]\'\'\'\\(/g,"1l($1,3,");q=q.l(/[2o]\'\'\'\\(/g,"1l(0,3,");q=q.l(/[2o]\'\'\'\'\\[([\\d]+)\\]\\(/g,"1l($1,4,");q=q.l(/[2o]\\[([\\d]+)\\]\'\'\'\'\\(/g,"1l($1,4,");q=q.l(/[2o]\'\'\'\'\\(/g,"1l(0,4,");q=q.l(/f\\(/g,"g(")}19{q=q.l(/[gy]\'\\[([\\d]+)\\]\\(/g,"1l($1,1,");q=q.l(/[gy]\\[([\\d]+)\\]\'\\(/g,"1l($1,1,");q=q.l(/[gy]\'\\(/g,"1l(0,1,");q=q.l(/[gy](\'\'|")\\[([\\d]+)\\]\\(/g,"1l($2,2,");q=q.l(/[gy]\\[([\\d]+)\\](\'\'|")\\(/g,"1l($1,2,");q=q.l(/[gy](\'\'|")\\(/g,"1l(0,2,");q=q.l(/[gy]\'\'\'\\[([\\d]+)\\]\\(/g,"1l($1,3,");q=q.l(/[gy]\\[([\\d]+)\\]\'\'\'\\(/g,"1l($1,3,");q=q.l(/[gy]\'\'\'\\(/g,"1l(0,3,");q=q.l(/[gy]\'\'\'\'\\[([\\d]+)\\]\\(/g,"1l($1,4,");q=q.l(/[gy]\\[([\\d]+)\\]\'\'\'\'\\(/g,"1l($1,4,");q=q.l(/[gy]\'\'\'\'\\(/g,"1l(0,4,");q=q.l(/f\'\\(x\\)/g,"dy");q=q.l(/f\'x/g,"dy");q=q.l(/fx/g,"y");q=q.l(/dx/g,"1")}w 2f,3L,3M,37;q=q.l(/≥/g,">=").l(/≤/g,"<=").l(/\\++/g,"+").l(/(\\-\\-)+/g,"+").l(/\\-(\\-\\-)+/,"-").l(/Γ/g,"γ").l(/γ\\(/g,"1p(-1+").l(/²/g,"^2").l(/³/g,"^3").l(/⁴/g,"^4").l(/⁵/g,"^5").l(/⁶/g,"^6").l(/⁷/g,"^7").l(/⁸/g,"^8").l(/⁹/g,"^9").l(/cw/g,"x*x*x").l(/cv/g,"x*x").l(/([\\d\\.]+|[a-zπ])\\!/g,"1p($1)").l(/\\(([^\\(^\\)]+)\\)\\!/g,"1p($1)").l(/([^o^t^a-z^A-Z])g\\(/g,"$1g[0](").l(/^g\\(/,"g[0](").l(/\\|([^\\|]+)\\|/g,"2h($1)").l(/f\\(x\\)/g,"y").l(/x\\(/g,"x*(").l(/x\\^-1/g,"(1/x)").l(/e\\^(-[\\d\\.cu])/g,"2a($1)").l(/e\\^\\(/g,"2a(").l(/([^\\(\\)\\^\\]\\[\\,\\.])\\^\\(/g,"Q($1,").l(/\\(([^\\)\\(\\[\\]\\.\\^\\,]+)\\)\\^\\(/g,"Q($1,").l(/₀/g,"ct").l(/₁/g,"cs").l(/₂/g,"cr").l(/₃/g,"cq").l(/₄/g,"cp").l(/₅/g,"co").l(/₆/g,"cn").l(/₇/g,"cm").l(/₈/g,"cl").l(/₉/g,"ck").l(/ₐ/g,"cj").l(/ₑ/g,"ci").l(/ₓ/g,"2T");if(q.48("3s")!=-1&&/(9E|m\\:)/.1F(q)){q=q.l(/([a-9F-Z])3s([\\d])/g,"$1*$2+");q=q.l(/([A-Z])([A-Z])/g,"$1+$2");q=q.l(/^(9E\\:|m\\:)/,"")}if(!5M){q=q.l(/θ/g,"5J").l(/5J/g,"(70(y/x))")};q=q.l(/([^\\)]|[\\d]+|[\\d]+\\.[\\d]+)\\^([\\d]|[^\\(^-])/g,"(Q($1,$2))").l(/([^\\)]|[\\d]+|[\\d]+\\.[\\d]+)\\^-([\\d]+|[^\\(^-])/g,"(Q($1,-$2))").l(/([a-z])\\^\\(([^\\)]+)\\)/g,"(Q($1,$2))").l(/\\(([^\\(^\\)]+)\\)\\^\\(([^\\(^\\)]+)\\)/g,"(Q($1,$2))").l(/\\(([^\\(^\\)]+)\\)\\^([^\\(^\\)])/g,"(Q($1,$2))").l(/ r /g,"(1S(x*x+y*y))").l(/([\\d]+)([^\\+^%^\\-^\\*^\\/^\\d^\\.^\\}^\\)^\\:^>^<^\\[^\\]^\\(^\\{^\\,])/g,"$1*$2").l(/([^3s^a-z^0-9][\\d]+)\\(/g,"$1*(").l(/^([\\d]+)\\(/,"$1*(").l(/\\)Q/g,")*Q").l("γ(n+1)","n!").l("1/(n*n)","n^-2").l(/\\)\\(/g,")*(").l(/\\(\\+?Q\\(([a-z]),([a-z])\\)\\)/g,"(Q($1,$2))");w 9D=q.48("∑")!=-1;q=q.l(/([ch])n/g,"$1é");q=q.l(/([∑∏])\\[n=/g,"$1[");q=q.l(/([∑∏])\\[([^,]+)\\.\\.\\./g,"$1[$2,");if(9D){1j(w 6Z=0;6Z<6;6Z++){q=q.l(/∑\\[([^,]+),([^,]+),([^\\]^\\+^\\-^n^\\(]+)\\*([^\\]^\\+^\\-]+)\\]/g,"($3)*∑[$1,$2,$4]");q=q.l(/∑\\[([^,]+),([^,]+),([^\\]^\\+^\\-]+)\\*([^\\]^\\+^\\-^n^\\)]+)\\]/g,"($4)*∑[$1,$2,$3]");q=q.l(/∑\\[([^,]+),([^,]+),([^\\]^\\+^\\-^n^\\(]+\\([^\\]^\\+^\\-^n^\\(]+\\)[^\\]^\\+^\\-^n^\\(]+)\\*([^\\]^\\+^\\-]+)\\]/g,"($3)*∑[$1,$2,$4]");q=q.l(/∑\\[([^,]+),([^,]+),([^\\]^\\+^\\-]+)\\*([^\\]^\\+^\\-^n^\\(]+\\([^\\]^\\+^\\-^n^\\(]+\\)[^\\]^\\+^\\-^n^\\(]+)\\]/g,"($4)*∑[$1,$2,$3]")}q=q.l(/∑\\[([^,]+),∞,([^n^\\]]+)\\/(1p\\(n\\)|\\(1p\\(n\\)\\))\\]/g,"((e*$2)-∑[0,$1-1,$2/1p(n)])");q=q.l(/∑\\[([^,]+),∞,Q\\(([\\d]+|[^\\(^\\)]),n\\)\\/(1p\\(n\\)|\\(1p\\(n\\)\\))\\]/g,"(2a($2)-∑[0,$1-1,Q($2,n)])");q=q.l(/∑\\[([^,]+),∞,Q\\(([\\d]+),n\\)\\/(1p\\(n\\)|\\(1p\\(n\\)\\))\\]/g,"(2a($2)-∑[0,$1-1,Q($2,n)])");q=q.l(/1\\/Q\\(([^\\)^,]+),([^\\(^\\))]+)\\)/g,"Q($1,-$2)");w 2N=/∑\\[([^,]+),∞,Q\\(n,([^\\)]+)\\)\\]/.9C(q);if(2N!=1s){if(/0+/.1F(2N[1])){q=q.l(2N[0],"∞")}19{w 5O;if(!/x/.1F(2N[2])){5O=3K(-2N[2])}19{5O="3K(-"+2N[2]+")"}q=q.l(2N[0],"(("+5O+")-∑[1,"+2N[1]+"-1,Q(n,"+2N[2]+")])")}}q=q.l(/∑\\[([^,]+),([^,]+),n\\]/g,"(-0.5*(-1+($1)-($2))*(($1)+($2)))").l(/∑\\[0*[5q],∞,Q\\(n,([^n^\\(^\\)]+)\\)\\/\\(?1p\\(n\\)\\)?\\]/g,"(e*5N($1))").l(/∑\\[0*2,∞,Q\\(n,([^n^\\(^\\)]+)\\)\\/\\(?1p\\(n\\)\\)?\\]/g,"(e*5N($1)-1)").l(/∑\\[0*3,∞,Q\\(n,([^n^\\(^\\)]+)\\)\\/\\(?1p\\(n\\)\\)?\\]/g,"(e*5N($1)-1-Q(2,(-1+$1)))").l(/∑\\[0*[5q],∞,n\\/1p\\(n\\)\\]/g,"(e)").l(/∑\\[0*2,∞,n\\/1p\\(n\\)\\]/g,"(e-1)").l(/∑\\[0*3,∞,n\\/1p\\(n\\)\\]/g,"(e-2)").l(/∑\\[0*4,∞,n\\/1p\\(n\\)\\]/g,"(0.5*(2*e-5))").l(/∑\\[0*5,∞,n\\/1p\\(n\\)\\]/g,"((1/3)*(3*e-8))").l(/∑\\[([^,]+),∞,Q\\(([^\\,]+),-n\\)\\]/g,"((Q($2,1-$1))/(-1+($2)))").l(/∑\\[([^,]+),([^,]+),Q\\(([^\\,]+),-n\\)\\]/g,"(-((Q($3,-$1-$2))*(Q($3,$1)-Q($3,1+$2)))/(-1+($3)))").l(/∑\\[([^,]+),∞,Q\\(([^\\,]+),n\\)\\]/g,"((2h($2)<1)?Q($2,$1)/(1-$2):2b)").l(/∏\\[0,x,n\\]/g,"(0)");q=q.l(/∑\\[([\\d\\*\\+\\-a-4a]+),([\\d\\*\\+\\-a-4a]+|∞),([^\\]]+)\\]/,L(4n,a,b,c){if(c.48("n")==-1){J"(("+c+")*(1+("+b+")-("+a+")))"}19{3L="";if(b=="∞"){3M=20}19{3M=1K(b)}1j(37=1K(a);37<=3M;37++){3L+="+"+c.l(/n/g,37)}J"("+3L+")"}})}q=q.l(/ζ\\(([\\d\\.]+)\\)/g,L(x,z){J 3K(z)});q=q.l(/ζ/g,"3K").l(/≠/g,"!=").l(/∏\\[[12],([^,]+),n\\]/g,"1p($1)").l(/∏\\[([\\d\\*\\+\\-a-4a]+),([\\d\\*\\+\\-a-4a]+),n\\]/,"(1p($2)/1p(($1)-1))");2f=/∏\\[([\\d\\*\\+\\-a-4a]+),([\\d\\*\\+\\-a-4a]+|∞),([^\\]]+)\\]/.9C(q);if(2f!=1s){if(2f[3].48("n")==-1){q=q.l(2f[0],"Q("+2f[3]+",1+("+2f[2]+")-("+2f[1]+"))")}19{3L="1";if(2f[2]=="∞"){3M=20}19{3M=1K(2f[2])}1j(37=1K(2f[1]);37<=3M;37++){3L+="*("+2f[3].l(/n/g,37)+")"}q=q.l(2f[0],"("+3L+")")}}if(q[0]=="("&&q.48(",")!=-1){q="9B"+q}q=q.l(/^Q\\(x,2\\)\\+Q\\(y,2\\)=(.+)/,"1S(($1)-x*x)").l(/^Q\\(x,2\\)\\+([\\d\\/e\\*]+)\\*Q\\(y,2\\)=(.+)$/,"1S(($2-x*x)/($1))").l(/^([0-9e\\/\\*\\+\\-\\(\\)]+)\\*Q\\(x,2\\)\\+Q\\(y,2\\)=(.+)$/,"1S(($2-($1*x*x)))").l(/^([0-9e\\/\\*\\+\\-\\(\\)]+)\\*Q\\(x,2\\)\\+([0-9e\\/\\*\\+\\-\\(\\)]+)\\*Q\\(y,2\\)=(.+)$/,"1S(($3-($1*x*x))/($2))").l(/^[9A]=/,"").l(/^([\\da-z\\.\\*\\/]+)\\*[9A]=(.+)$/,"($2)/($1)").l(/∞/g,"1V").l(/¯/g,",").l(/Q\\((.),4\\)/g,"($1*$1*$1*$1)").l(/Q\\((.),3\\)/g,"($1*$1*$1)").l(/Q\\((.),2\\)/g,"($1*$1)").l(/Q\\((.),1\\)/g,"($1)").l(/Q\\((.),0\\)/g,"(1)").l(/Q\\(e,([^\\)^\\(]+)\\)/g,"2a($1)").l(/\\(\\)/g,"(0)").l(/\\)([a-z])/g,")*$1");if(5M!=1s){q=q.l(/fx/g,"(g[0](x))")}q=q.l(/é/g,"n");q=q.l(/(1A|33|2m|ln|1X|2h|5L|5K|46|45|6Y|3r|2a)\\*?x/g,"$1(x)");q=q.l(/Q\\(([\\d\\.]+),([\\d\\.]+)\\)/,L(d,x,y){J Q(x,y)});q=q.l(/Q\\(([\\d\\.^,]+),([\\d\\.^,\\+\\-]+)\\)/,L(d,x,y){J Q(x,1K(y))});q="("+q+")";q=q.l(/([\\+\\*\\/\\-])\\(0\\)/g,"$10");q=q.l(/\\)\\-0\\)/g,"))");q=q.l(/é/g,"n");q=q.l(/(1A|33|2m|ln|1X|2h|5L|5K|46|45|6Y|3r|2a)x/g,"$1(x)");q=q.l(/\\(\\(([\\d\\.]+)\\)\\)/g,"($1)");q=q.l(/\\(\\(([\\d\\.]+)\\)\\)/g,"($1)");q=q.l(/\\(\\(([\\d\\.]+)\\)\\)/g,"($1)");q=q.l(/\\(\\(([\\d\\.]+)\\)\\)/g,"($1)");q=q.l(/([\\+\\*\\/\\-])\\(([\\d\\.]+)\\)/g,"$1$2");q=q.l(/\\(([\\d]+[\\*\\+\\-\\/][\\d]+)\\)/,L(d,x,y){J 1K(x)});q=q.l(/\\+\\)/g,")");if(q=="()"){q=""}q=q.l(/\\)([\\d])/g,")*$1");if(q[0]=="("&&q[q.1c-1]==")"){q=q.6X(1,q.1c-1)}q=q.l(/^(.+)[\\|\\:]\\[([\\d\\-\\.\\+]+),([\\d\\-\\.\\+]+)\\]$/,"((x>($2))&&(x<($3)))?($1):2b");q=q.l(/α/g,"9z").l(/β/g,"9y").l(/γ/g,"6W").l(/δ/g,"9x").l(/ζ/g,"3K").l(/η/g,"9w").l(/θ/g,"5J").l(/ι/g,"9v").l(/κ/g,"9u").l(/μ/g,"9t").l(/ν/g,"9s").l(/ξ/g,"9r").l(/ο/g,"9q").l(/ρ/g,"9p").l(/σ/g,"9o").l(/τ/g,"9n").l(/υ/g,"9m").l(/χ/g,"9l").l(/ψ/g,"9k").l(/ω/g,"9j").l(/ϕ/g,"4L").l(/φ/g,"9i").l(/ϵ/g,"9h").l(/ε/g,"9g").l(/ς/g,"9f").l(/ϝ/g,"9d").l(/ϰ/g,"9c").l(/ϖ/g,"9b").l(/ϱ/g,"99").l(/ϑ/g,"97").l(/π/g,"1G").l(/λ/g,"5I").l(/Γ/g,"43").l(/Δ/g,"94").l(/Θ/g,"93").l(/Λ/g,"8Z").l(/Ξ/g,"8Y").l(/Π/g,"8X").l(/Σ/g,"8W").l(/Υ/g,"8V").l(/Φ/g,"8U").l(/Ψ/g,"8T").l(/Ω/g,"8S").l(/⊥/g,"8R").l(/∇/g,"8Q").l(/∀/g,"8P").l(/∐/g,"8O").l(/∫/g,"8N");q=q.l(/\\)1d/g,")*1d");if(/\\^/.1F(q)){5H("cg")}J q}L 6O(q){2D{w 8M=2L(q,1r);w 2l=1K("(L (x) { 8K(1d){ J "+8M+";}})");2l(2.cf);J 2l}2C(ex){J 1k}}L 8L(){1h.3I=1o.ce("cd/4u")}L 6N(q){2D{w 2l=1K("(L(x,y,dx,dy){ 8K(1d) { J "+2L(q)+";} } )");2l(2.cc);J 2l}2C(ex){J 1k}}L 6V(1i){2D{1K(2L(1i.R));1i.1a.2M="3X"}2C(ex){1i.1a.2M="5B"}}w 4K=1k;L 3J(){4K=!4K;31.1a.1B=4K?"8J":"cb";31.1a.1t=4K?"8J":"ca";J"c9"}L 8I(){41.1a.1J=(41.1a.1J==\'1P\'?\'6p\':\'1P\');1b.1n("8H").6U();6T("6S "+41.1a.1J)}L 4I(5G,8E){5G=21.4J(5G);w 1e=1b.5F("1u");w 1f=1b.5F("b");1f.1a.8G="1f";1e.1a.8G="1e";1e.1a.c8="c7 c6 #c5";w 8F=1b.6R(5G.4F());1e.3q(8F);w 8D=1b.6R(8E);1f.3q(8D);w 5E=1b.5F("1u");5E.3q(1f);5E.3q(1e);31.3q(5E);31.c4=31.c3}w 5D=1s;w 6Q="";L 8C(1I){6Q=1I.R;if(1I.R==""){J}if(/^[\\*\\+\\/]/.1F(1I.R)){1I.R="5D"+1I.R}w 1i;2D{w 8B=1k;1i=1K("("+(1I.R)+")");5D=1i;4I(1i,1I.R);8B=1r}2C(ex){2D{w 6P=2L(1I.R);1i=1K("("+6P+")");5D=1i;4I(1i,1I.R+"="+6P+" .")}2C(8A){4I(8A.c2,"!"+1I.R)}}1I.R=""}L c1(){31.6l="";J"c0 bZ"}L 8z(1i,3Z,bY){if(1i===2b){1i=1v.2t[3Z].3e("2U")[0].4q(1Q)[0]}if(3Z>(g.1c-1)){1z();J}w 8y=4r(1i);if((3Z!=0)&&(3Z==(1v.2t.1c-1))&&(8y=="")){5C();1z();J}w 2l=6O(4r(1i));if(2l){1i.1a.2M="3X";g[3Z]=2l;1z()}19{1i.1a.2M="5B"}3H()}w 4x=1k;L 8x(1i){if(1i.R==""){4x=1k;1i.1a.2M="3X";J 1z()}w 2l=6N(1i.R);if(2l){1i.1a.2M="3X";E=2l;4x=1r}19{4x=1k;1i.1a.2M="5B"}1z()}1h.8c=L(){if(1h.6y){1B=1h.6y;1t=1h.8d}if(!1B){1B=1b.2B.bX}if(!1t){1t=1b.2B.bW}if(!1t){1t=bV}1o.1B=1B;1o.1t=1t;if(1z&&D){1z()}};L 6M(){3j=2k;w df=E(2z,2k,dx,dy);if(df==1V){3j=2k+0.2F;df=E(2z+0.2F,3j,dx+0.2F,dy+0.2F)}if(4H){dx=1;dy+=3p*df}19{w 3V=1d.1S(1+df*df);dx=1/3V;dy=df/3V}2z+=3p*dx;2k+=3p*dy;if(4H){2z-=3p*3p/2;2k-=3p*3p*df/2}}L 5A(){3o.R=2j?"4E":"3Y";D.3H();w 17=1W*1t/15;D.1N(2V,3f);D.17(17,17);D.2Y="5B";D.3E=2/17;D.1C();w z;1j(z=0;z<30;z++){6M()}2i(lx,ly);1L(2z,2k);lx=2z;ly=2k;D.1y();D.8o();if(2z<3W&&2j){if(2z>4C){if(2k<1M){if(2k>1T){5v(5A,0);J}}}}if(!2j){1z()}2j=1k;3o.R=2j?"4E":"3Y"}L 3i(1E,6L){e=1d.E;1G=1d.2K;if(!1E){J"0"}19 if(1E==1G){J"π"}19 if(1E==e){J"e"}19 if(1E%(1G/4)==0){J(1E/1G)+"π"}19 if(1E%(1/3)==0){J(1E*3)+"/3"}19 if(1E%(e/4)==0){J(1E/e)+"e"}19 if(1E!=1){if((1X(1E))%1==0){w 4G=1X(1E);w 8w="⁰¹²³⁴⁵⁶⁷⁸⁹";J"e"+((2h(4G)<10)?((4G<0?"⁻":"")+8w[2h(4G)]):"^"+4G)}}if(6L===2b){J 1E.4F()}if(1E.8v){if(1d.2h(1E)<0.bU){J"0.bT"}J 1E.8v(6L)}J 1E}L 8u(x,y){3o.R=2j?"4E":"3Y";2D{1K(2L(x));1K(2L(y));1K("8s("+2L(x)+","+2L(y)+")")}2C(ex){6s("8t: bS bR bQ: "+ex)}}1b.2B.6w=L(2v){4w=1k;1o.1a.5j="6u";1z()};L 8s(8r,8q){ix=8r;iy=8q;2z=ix;2k=iy;dx=1;dy=0;lx=2z;ly=2k;2j=1r;3o.R=2j?"4E":"3Y";5A()}L f(n){J 3j}g.2Z(L(x){J x*x+x-2});L 6E(){if(4w){1z();5v(6E,6D)}}if(!/(bP[p]h\\.[t]k|an[t]bO)/.1F(1h.3I.1H)){}L 1z(){e=1d.E;1G=1d.2K;if(!D){J}D.bN="bM";3f+=cy;2V+=cx;cy=cx=0;1o.1a.6z=cy+"29";1o.1a.1f=cx+"29";3o.R=2j?"4E":"3Y";D.bL(0,0,1B,1t);D.3H();w 17=1W*1t/20;17=1W*1t/15;D.1N(2V,3f);D.17(17,17);4C=(-2V)/17;3W=(1B-2V)/17;1T=-(1t-3f)/17;1M=3f/17;w 1q=Q(2,6-~~(1X(17)/1X(2)));w 2w=1q*~~(4C/1q)-1q;w 2I=1q*~~(3W/1q)+1q;w 3F=1q*~~(1M/1q)+1q;w 3k=1q*~~(1T/1q)-1q;D.2Y="2H";D.3E=2/17;D.1C();2i(2w,0);1L(2I,0);D.1y();D.1C();2i(0,3k);w gy;1L(0,3F);D.1y();D.3E=2/17;1j(w 1R=0;1R<g.1c;1R++){w 2y=g[1R](1G/(0.bK*e));D.2Y=4D[1R];D.5w="3X";if(2y==1s&&(g[1R](bJ.bI)==1s)&&(g[1R](0.1)==1s)){D.5w="2H";D.2Y="2H";D.2J="6J 4A-4z"}19 if(1x 2y=="3G"){D.1C();if(2y.x!=2b&&2y.x<3W&&2y.x>4C&&2y.y!=2b&&2y.y<1M&&2y.y>1T){D.5z(2y.x,-2y.y,3/17,0,1d.2K*2,1r)}D.5y();D.5x();D.1y();D.5w="2H";D.2Y="2H";D.2J="6J 4A-4z"}19{D.1C();w 8p=(2I-2w)*(g.1c>10?4:1)/1B;w 4B=0;w 1D=[];w 2c=1s;1j(w x=2w;x<=2I;x+=8p){gy=g[1R](x);w 6K=2h(gy-2c)>6D/17;if(!3z(gy)&&(gy!=1V)&&(gy!=-1V)){if(2c==1s||6K){if(6K&&(2c!=1s)){D.1y();D.1C();if(2c<1M&&2c>1T){D.5z(x,-2c,3/17,0,1d.2K*2,1r)}D.5y();D.5x();D.1y()}D.1C();if(gy<1M&&gy>1T){D.5z(x,-gy,3/17,0,1d.2K*2,1r)}D.5y();D.5x();D.1y();D.1C();2i(x,gy)}19{1L(x,gy)}if(gy>0){if(4B==2){1D.2Z(x)}4B=1}19 if(gy<0){if(4B==1){1D.2Z(x)}4B=2}}19 if(2c!=1s){D.1y();D.1C();if(2c>1T&&2c<1M){D.5z(x,-2c,3/17,0,1d.2K*2,1r)}D.5y();D.5x();D.1y()}2c=1s;if(!3z(gy)&&(gy!=1V)&&(gy!=-1V)){2c=gy}}D.1y();D.5w="2H";D.2Y="2H";D.2J="6J 4A-4z";if(1D.1c>0){1j(w z=0;z<1D.1c;z++){w 4y=1k;if(g[1R](3n(1D[z]*30)/30)==0){1D[z]=3n(30*1D[z])/30;4y=1r}19 if(g[1R](3n(1D[z]*40)/40)==0){1D[z]=3n(40*1D[z])/40;4y=1r}19 if(g[1R](3n(1D[z]*50)/50)==0){1D[z]=3n(50*1D[z])/50;4y=1r}if(4y&&(1D[z]%1q!=0)){D.1N(1D[z],0);D.17(1/ 17, 1 /17);D.1N(0,-20);if(D.3l){D.3l(3i(1D[z]),-2,2)}D.1N(0,20);D.17(17,17);D.1N(-1D[z],0);D.1C();1L(-30/17,0);1L(30/17,0);D.1y()}}}x=0;if(0>2w&&0<2I){gy=g[1R](x);if(!3z(gy)&&gy>1T&&gy<1M&&gy!=1V&&gy!=-1V&&(1d.2h(gy*17)>15)){w 3m=gy;x=0;D.1N(x,-3m);D.17(1/ 17, 1 /17);D.1N(20,0);if(D.3l){D.3l(3i(gy),-2,2)}D.1N(-20,0);D.17(17,17);D.1N(-x,3m);D.1C();1L(-3/17,gy);1L(3/17,gy);D.1y()}}}}D.2Y="#bH";D.3E=0.4/17;1j(w x=2w;x<=2I;x+=1q){D.1C();2i(x,3k);1L(x,3F);D.1y()}1j(w y=3k;y<=3F;y+=1q){D.1C();2i(2w,y);1L(2I,y);D.1y()}D.3E=0.1/17;1j(w x=2w;x<=2I;x+=1q/4){D.1C();2i(x,3k);1L(x,3F);D.1y()}1j(w y=3k;y<=3F;y+=1q/4){D.1C();2i(2w,y);1L(2I,y);D.1y()}D.3E=2/17;D.2Y="2H";1j(w x=2w;x<=2I;x+=1q){D.1C();2i(x,-3/17);1L(x,3/17);D.1y();w 3m=0;if(0>1M){3m=-1M}if(0<1T){3m=-1T-0.5/1W}D.1N(x,3m);D.17(1/ 17, 1 /17);D.1N(3,12);if(D.3l){D.3l(3i(x),-2,2)}D.1N(-3,-12);D.17(17,17);D.1N(-x,-3m)}1j(w y=3k;y<=3F&&0;y+=1q){D.1C();2i(-3/17,y);1L(3/17,y);D.1y();w 6I=0;D.1N(6I,y);D.17(1/ 17, 1 /17);if(D.3l){D.3l(3i(y),-2,-2)}D.bG(0,0,10,10);D.17(17,17);D.1N(-6I,-y)}D.2Y="2H";D.3E=0.4/17;if(4x){1j(w x=2w;x<3W;x+=1q/4){1j(w y=3k;y<1M;y+=1q/4){D.1C();3j=y;w 3D=E(x,y,0,0);if(3D==1V||3z(3D)){3j=y+0.2F;3D=E(x+0.2F,3j,0,0)}w 3V=1d.1S(1+3D*3D);w 6H=1q/ 10 * 1 /(3V);w 6G=1q/ 10 * 3D /(3V);2i(x-6H,y-6G);1L(x+6H,y+6G);D.1y()}}}D.8o()}1o.1a.5j="6u";1o.6m=L(e){if(e.x){2G=e.x;2W=e.y}19{2G=e.3S;2W=e.3R}5t=2G;5r=2W;4w=1r;1o.1a.5j="bF(6F.8n), 6F";if(!3Q){5v(6E,6D)}};1b.2B.6o=L(e){if(!e){e=1h.2v;if(!e){J}}if(e.x!==2b){2G=e.x;2W=e.y}19{2G=e.3S;2W=e.3R}if(!4w){w 17=1W*1t/15;if(1U>g.1c){1U=0}if(1U==g.1c){2u.1a.2S=0}19{2u.1a.2S=0.6}if(1U<g.1c){w 2X=((2G-2V)/17);w 5u=((3f-2W)/17);w 3U=7H(1U,27,(2G-2V)/17);if(2h(g[1U](3U))>0.2F){3U="?"}2X=3i(2X,4);5u=3i(5u,4);3U=3i(3U,7);2X="("+2X+","+5u+")";8m(2X.1c<18){2X+=" "}2X+=" g["+1U+"] bE: "+3U;2u.2t[0].7C=2X}J}cx+=2G-5t;cy+=2W-5r;1o.1a.1f=cx+"29";1o.1a.6z=cy+"29";5t=2G;5r=2W};L 7P(n){w ls=1X(1W);ls+=n*0.2F;1W=2a(ls);w 17=1W*1t/20;1z()}L 8e(e){e=e?e:1h.2v;if(e.8l){e.8l()}if(e.5f){e.5f()}e.bD=1r;e.bC=1r;e.bB=1k;J 1k}w 3T=0.2F;if(/bA\\/[\\d]+\\.[\\d]+\\+/.1F(3h.3g)){3T=0.5q}if(/6C/.1F(3h.3g)){3T=0.5q}if(/6B/.1F(3h.3g)){3T=0.bz}if(/6A/.1F(3h.3g)||!/by bx X/.1F(3h.3g)){3T=0.1}L 8i(2E,5p,5o){if(1x(2E)=="q"){2E=1b.1n(2E)}if(2E==1s){J}if(2E.3y){if(5p==\'8h\'){2E.3y(\'bw\',5o,1k)}2E.3y(5p,5o,1k)}19 if(2E.8k){2E.8k("8j"+5p,5o)}}8i(1o,\'8h\',L(e){w 8f=e.8g?e.8g*-1:e.bv/40;w ls=1X(1W);ls+=8f*3T;1W=2a(ls);w 17=1W*1t/20;1z();cy=0;1o.1a.6z=cy+"29";2D{1b.2B.6o(e)}2C(ex){}8e(e)});1B=1h.6y;1t=1h.8d;1o.1B=1B;1o.1t=1t;1W=2;1h.8c();3f=2*1t/3;2V=1B/3;if(1o.8b){D=1o.8b("2d")}19{1b.1n("8a").4v="5m.4u";1b.1n("89").4v="5l.4u";1b.1n("86").4v="6x.4u";1b.1n("82").4v="5k.4u";1o.6m=L(){};1o.6w=L(){}}1v.6v(1v.81);g=[];4i(80);1o.1a.5j="6u";w 5i=1k;L 6t(){5i=!5i;1b.1n("3C").1a.1J=5i?"6p":"1P"}L 4p(d){if(d.5d=="6q"){if(d.g.1c>10){if(!bu("bt bq 5h 3P 7T "+d.g.1c+" 7X. bp 7Z bo 7Z bn 7Y 7X?")){4t.7W("fn",1s);J}}if(d.df){1b.1n("7V").3B();6t()}1j(w n=0;n<d.g.1c;n++){if(d.g[n]!=""){if(n>0){4i(d.g[n])}19{7U(1v.2t[n].3e("2U")[0].4q(1Q)[0],d.g[n])}}}}19{6s("bm - bl 3P 7T bk 1Z.")}}w 4l=1k;if(7S){if(1h.4t){w 1Z=4t.bj("fn");if(1Z!=1s){2D{1Z=21.4s(1Z);4p(1Z)}2C(ex){}}}4l=1r}19 if(6r!=1s){w 1Z=6r;if(1h.21){2D{1Z=21.4s(1Z);4p(1Z)}2C(ex){}}19{1Z=1K("("+1Z+")");4p(1Z)}}if(!3Q&&g.1c==1&&4r(1v.2t[0].3e("2U")[0].4q(1Q)[0])=="e^x"){4p({"5d":"6q","g":["e^x","\\\\3d{1}{8}\\\\1f(x+2\\\\1e)\\\\1f(x-4\\\\1e)^2","f\'\\\\1f[1\\\\1e]\\\\1f(x\\\\1e)","\\\\4o{n=1}^{\\\\7R}\\\\3d{\\\\1A\\\\1f(5g\\\\1e)}{n}"]});1U=1}1z();1b.1n("bi").1a.1J="1P";1b.1n("4n").1a.1J="6p";$(\'#1v\').3A("7Q");w 4m=0;L 7I(2v){2v.5f();w 1w=2v.7O;if(1w.1c==1){1b.2B.6o({x:1w[0].3S,y:1w[0].3R})}19 if(1w.1c==2){w dx=1w[1].3S-1w[0].3S;w dy=1w[1].3R-1w[0].3R;w 6n=1d.1S((dx*dx)+(dy*dy));if(4m!=0){7P(6n-4m)}4m=6n}}L 7J(2v){4m=0;w 1w=2v.7O;if(1w.1c>0){1o.6m({x:1w[0].3S,y:1w[0].3R});2v.5f()}}if(3Q){1b.1n("7N").1a.1J="1P";1b.1n("bh").1a.1J="1P";1b.1n("7M").1a.1J="1P";1b.1n("7L").1a.1J="1P";1b.1n("7K").1a.1J="1P";1b.2B.3y("bg",7J,1k);1b.2B.3y("bf",1z,1k);1b.2B.3y("bd",7I,1k)}if(!4l){1b.1n("6k").6l="6k"};L 7H(1R,7F,7G){w 2T=7G;1j(w it=0;it<7F;it++){w m=1l(1R,1,2T);w 7E=g[1R](2T);2T-=7E/m;if(m===0){7D}}if(3z(2T)||2T==1V||2T==-1V){J 1V}J 2T}if(3Q||1h.5c.1c>0){2u.1a.1J="1P"}19{2u.4k=L(){1U++;if(1U>g.1c){1U=0}if(1U==g.1c){2u.1a.2S=0}19{2u.1a.2S=0.6;2u.2t[0].7C="bc 3P L 5e "+1U}}}if(1h.3O){1h.3O.3y(\'bb\',L(){if(1h.3O.5d==1h.3O.ba){2D{1h.3O.b9();1h.3O.b8()}2C(ex){}}},1k)}if(1Q=="2s"){1b.2B.2g=L(e){if(e.b7&&e.4j===13){4i()}}}if(1h.5c.1c){1b.1n("7B").1a.1J="1P"}6j=1r;',62,1375,'|||||||||||||||||||||replace|||||string||||||var|||||||ctx||||||return||function|||||pow|value||||||||||||||||scale||else|style|document|length|Math|right|left||window|obj|for|false|djkb|this|getElementById|canvas|fact|gridsize|true|null|height|div|flist|tk|typeof|stroke|draw|sin|width|beginPath|xintercepts|num|test|pi|href|val|display|safeeval|plot|boundtop|translate|td|none|kinput|gid|sqrt|boundbottom|showp|Infinity|scalex|log|gap|data||JSON||||||||px|exp|undefined|lasty|||sargs|onkeydown|abs|plotf|solving|sy|func|tan||gfy|inputbox|text|http|span|childNodes|ptd|event|overleft||dsd|sx|partial|body|catch|try|element|001|mx|black|overright|font|PI|extrafunc|background|args|type|input|com|py|opacity|_10|matheditor|panx|my|stra|strokeStyle|push||logt||cos||||iad|||index|key|www|frac|getElementsByClassName|pany|userAgent|navigator|forms|fofy|overbottom|fillText|ty|round|stopper|step|appendChild|cot|_|sum|class|rep|prototype|tr|addEventListener|isNaN|mathquill|onchange|overlay|Ef|lineWidth|overtop|object|save|location|size|zeta|ext|enn|toJSON|applicationCache|to|iphone|pageY|pageX|scaleconst|strc|mag|boundright|white|Solve|idd||con||Gamma||csc|sec||indexOf||wyz|out|holder|replacer|graph|small|the|difflevel|newfunc|which|onclick|ready|lsd|all|sum_|loadd|getElementsByTagName|getstr|parse|localStorage|png|src|drag|good|exact|serif|sans|state|boundleft|colors_in_use|Stop|toString|exponent|second|consolelog|stringify|big|phi|latexchars|colorss|other_node|newone|latex|submatch|str|space|indent|mind|case|nbsp|8px|javascript|||||||img|nau_g|||res|inj|parent|status|number|preventDefault|nx|about|sdiff|cursor|chrome|safari|firefox||callback|eventName|01|lmy||lmx|strb|setTimeout|fillStyle|fill|closePath|arc|nextframe|red|delfunc|ans|item|createElement|vla|throw|lambda|theta|ceil|floor|jjq|bellb|reparg|daex|funcval|onkeyup|split|String|call|join|quote|escapable|button|sub|margin|void|||||symbol|ease|transition||Get|alt|hash|randfuncs|infinity|naughty|lvl|nns|npw|loaded|nosave|innerHTML|onmousedown|ndst|onmousemove|block|ok|jsondata|alert|tdiff|default|removeChild|onmouseup|opera|innerWidth|top|Chrome|Opera|Firefox|1000|drawwhiledrag|grabbing|nEy|nEx|tx|8pt|jmp|digits|calcnextframe|get2dfunction|getfunction|ddsddd|last|createTextNode|Console|_11|focus|valiad|gamma|substring|tg|nnnd|atan|||diff||||logb|||this_node|randfunc|proto|od|Error|new|walk|reviver|eval|Object|_12|target|of|License|GNU|or|version|Mono|Safari|google|r_e|m_e|lineTo|moveTo|vy|vx|blln|funcs|nodeValue|break|y_1|itterations|start|newton|tmove|tstart|tss|pb|sde|shc|changedTouches|scrl|redraw|infty|shouldload|load|setstr|nnn|setItem|graphs|these|you|jsonfunc|firstChild|i_chrome||||i_opera|||i_safari|i_firefox|getContext|onresize|innerHeight|cancelEvent|wheelData|detail|mousewheel|hookEvent|on|attachEvent|stopPropagation|while|gif|restore|stepx|inity|initx|numsolve|error|dosolve|toPrecision|exptext|getg|strdata|getf|xbb|done|consoleex|ltext|question|rtext|textAlign|conin|showcon|500px|with|scren|dddd|int|coprod|forall|nabla|perp|Omega|Psi|Phi|Upsilon|Sigma|Pi|Xi|Lambda||||Theta|Delta|||thetav||rhov||piv|kappav|gammad||sigmaf|epsiv|epsilon|phiv|omega|psi|chi|upsilon|tau|sigma|rho|omicron|xi|nu|mu|kappa|iota|eta|delta|beta|alpha|yfg|pt|exec|hassum|mass|zA|log_|1_n|Ii|splice|delete_button_node|lastChild|pop|currentnodeslength|inputbox_container|cloneNode|getlatexpart|not|Array|07c|f08|slice|charCodeAt|0000|lastIndex|delete|hasOwnProperty|isFinite|meta|uffff|ufff0|ufeff|u206f|u2060|u202f|u2028|u200f|u200c|u17b5|u17b4|u070f|u0604|u0600|u00ad|valueOf|Date|table|tbody|y0||x0|bottom|ul|Fe|way|that|but|will|Public|General|Lesser|family|aantthony|github|Sans|download|apple|mozilla|Google|one|randomfi|100000x|prod_|H_2SO_4|dotprod|pageTracker|log2pi|other|cond|random|min|max|atan2|asin|acos|Te|262|259|247|210|207|192|140|9994|6378100|shiftKey|swapCache|update|UPDATEREADY|updateready|Set|touchmove||touchend|touchstart|quest|ldall|getItem|corrupted|tried|Warning|want|sure|Are|are|||You|confirm|wheelDelta|DOMMouseScroll|OS|Mac|03|AppleWebKit|returnValue|cancel|cancelBubble|root|url|fillRect|888|2101|301|3329|clearRect|butt|lineCap|scape|gra|values|starting|invalid|0000000|0000001|120|clientHeight|clientWidth|force|Cleared|Log|clear|message|scrollHeight|scrollTop|444|solid|1px|borderBottom|OK|117px|331px|4324234215123|image|toDataURL|4324234215125|xor|ail|_13|_14|_9|_8|_7|_6|_5|_4|_3|_2|_1|_0|xy|xx|xxx|||875|625|375|125|nf|nfinity|nextSibling|parentNode|ctrlKey|keydown|trigger|editable|getAttribute|match|integral|coproduct|product|prod|summation|vartheta|varrho|varpi|varkappa|digamma|Gammad|sigmav|varepsilon|varphi|cdot|col|f00|0a0|04f|f0f|f80|0ff|808||088|880|80f|8f0||SyntaxError|bfnrt|apply|boolean|switch|x9f|x7f|x1f|x00|u0000|Boolean|Number|getUTCSeconds|getUTCMinutes|getUTCHours|getUTCDate|getUTCMonth|||getUTCFullYear|removeAttribute|scaley|300|400|100px|ldocation|Info|float|Screenshot|Eq|Diff|New|100|H_2O|things|cool|Some|change|Use|standard|non|evaluated|was|means|expression|after|dot|equations|easier|some|allow|modifications|made|have|meaning|normal|XOR|power|Sometimes|Notes|details|more|See|PURPOSE|PARTICULAR|FOR|FITNESS|MERCHANTABILITY|warranty||implied|even|without|WARRANTY|ANY|WITHOUT|useful|hope|distributed||program|This|GitHub|code|Source|LGPL||title|html|lgpl|licenses|org|gnu|Anthony|2010|copy|commit|https|v1|monospace|monofur|Monaco|Lucida|Droid|DejaVu|Consolas|Andale|Menlo|10pt|moz|webkit|border|color|80000|Index|fixed|position|middle|align|another|find|browsers|Choose||Download|page|About|old|too|browser|internet||Your|16px|600|800|unescape|frac1x|sinx|lnx|Code||Unsafe|clip||xmlhttp|xml|child|prompt|comfirm|cookie|Windows|Graph|_15|iPhone|0001|3245138289924575|7281333047988399|24425221666910216|150917639897307|1680|1260|360|4506715738447323|474869816156751|51724158235372|5832742205057|682076806159|82864869804|10480142147|1382958545|190899322|27644437|4213597|678570|115975|21147|4140|877|203|ctn|ctg|cosec|sinc||piecewise|signum|ln_n|log_n|csc_n|sec_n|cot_n|tan_n|cos_n|sin_n|Rg|Ds|Mt|Hs||Bh|Sg|Db|Rf||Lr|No|Md|Fm|Es|Cf|Bk|Cm|Am|Pu|Np|Pa|Th|Ac|Ra|Fr|Rn|At|Po|Bi|Pb|Tl|Hg|Au|Pt|Ir|Os|Re||Ta|Hf|Lu|Yb|Tm|Er|Ho|Dy|Tb|Gd|Eu|Sm|Pm|Nd|Pr|Ce|La|Ba|Cs|Xe|Sb|Sn|In|Cd|Ag|Pd|Rh|Ru|Mo|Nb|Zr|Sr|Rb|Kr|Br|Se|As|Ge|Ga|Zn|Cu|Ni|Co|Mn|Cr|Ti|Sc|Ca|Ar|Cl|Si|Al|Mg|Na|Ne|Be|Li|He|Zero|272|271|268|277|264|266|261|258|257|252|251||243|244||237||02891|238|03588|231|03806|232|227||226|223|220|980401|||208|3833|204|||200|966569|196|084|217|190|186|183|94788|180|178|9668|174|054|173|93421|168|167|93032|164|5001|162|92535|158|157|964|151|150|145|242|144|90765|116|90547|138|327|137|9054519|132|293|131|90447|126|127|121|118|818|114|411|112|8682|107|106|9055|102|07|101|90638|224|90585|4678|798|904|9216|723|546|6934|933195|845|938045|9961|9415|867|955912|078|0983|948|453|065|973762|0855|9815386|305|98976928|1797|0067|0107|811|012182|941|002602|00794|Unununium|Ununnilium|Meitnerium|Hassium|Bohrium|Seaborgium|Dubnium|Rutherfordium|Lawrencium|Nobelium|Mendelevium|Fermium|Einsteinium|Californium|Berkelium|Curium|Americium|Plutonium|Neptunium|Uranium|Protactinium|Thorium|Actinium|Radium|Francium|Radon|Astatine|Polonium|Bismuth|Lead|Thallium|Hydrargyrum|Gold|Platinum|Iridium|Osmium|Rhenium|Tungsten|Tantalum|Hafnium|Lutetium|Ytterbium|Thulium|Erbium|Holmium|Dysprosium|Terbium|Gadolinium|Europium|Samarium|Promethium|Neodymium|Praseodymium|Cerium|Lanthanum|Barium|Cesium|Xenon|Iodine|Tellurium|Antimony|Tin|Indium|Cadmium|Silver|Palladium|Rhodium|Ruthenium|Technetium|Molybdaenum|Niobium|Zirkonium|Yttrium||Strontium|Rubidium|Krypton||Bromine|Selenium|Arsenic|Germanium||Gallium|Zinc|Copper|Nickel|||Cobalt|Iron|Manganese|||Chromium|Vanadium|Titanium|Scandium|Calcium|Potassium|Argon|Chlorine|Sulphur|Phosphorus|Silicon|aluminium|Magnesium|Sodium|Neon|Fluorine|Oxygen|Nitrogen|Carbon|Boron|Beryllium|Lithium|Helium|Hydrogen|Massless|85418782e|epsilon_0|8378770664093453|626068e|R_E|98892e30|m_s|36e22|m_m|9742e24|67300e|299792458|970413d'.split('|'),0,{}))
