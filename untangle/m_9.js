...
return {
"attachTimeListener":function(func){onchange=func;},
"getValue": function(){
return time/1000;
    },
"reset":function(){
...
function tmove (event){
    ...
    canvas.onmousemove({"layerX":tk[0].pageX,"layerY":tk[0].pageY});
}
...
function tstart(event){
    ...
    for(var i = 0; i < tk.length; i++ ){
        ...
        mmx=touch.pageX;
        mmy=touch.pageY;
        canvas.onmousemove({"layerX":touch.pageX,"layerY":touch.pageY});
        return;
    }
}
