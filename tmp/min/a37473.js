...
}(jQuery));eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)d[e(c)]=k[c]||e(c);k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('J j8(1U,7l){e=1p.E;27=1p.3Z;if(!1U){D"0"}R if(1U==27){D"π"}R if(1U==e){D"e"}R if(1U%(27/4)==0){D(1U/27)+"π"}R if(1U%(1/3)==0){D(1U*3)+"/3"}R if(1U%(e/4)==0){D(1U/e)+"e"}R if(1U!=1){if((1y(1U))%1==0){q 4V=1y(1U);q 9t="⁰¹²³⁴⁵⁶⁷⁸⁹";D"e"+((3M(4V)<10)?((4V<0?"⁻":"")+9t[3M(4V)]):"^"+4V)}}if(7l===1E){D 1U.1m()}if(1U.9s){if(1p.3M(1U)<0.j7){D"0.j6"}D 1U.9s(7l)}D 1U}J 5Z(){q s="";1j(q i=0;i<20;i++){s+=(~~(1p.3L()*16)).1m(16)}D s}q c=j5;q G=6.j4-11;q 7t=5.j3;q j2=7.j1;q j0=1.iZ;q iY=9r;q 7s=9r;q h=6.iX-34;q 9f=1.iW;q e=1p.E;q 27=1p.3Z;q 67=(1+1p.2O(5))/2;q iV=8.iU-12;q en=["iT iS","iR","iQ","iP","iO","iN","iM","iL","iK","iJ","iI","iH","iG","iF","iE","iD","iC","iB","iA","iz","iy","ix","iw","iv","iu","ir","iq","ip","io","il","ik","ij","ii","ih","ie","ic","ib","i9","i8","i7","i6","i5","i4","i3","i2","i1","i0","hZ","hY","hX","hW","hV","hU","hT","hS","hR","hQ","hP","hO","hN","hM","hL","hK","hJ","hI","hH","hG","hF","hE","hD","hC","hB","hA","hz","hy","hx","hw","hv","hu","ht","hs","hr","hq","hp","ho","hn","hm","hl","hk","hj","hi","hh","hg","hf","he","hd","hc","hb","ha","h9","h8","h7","h6","h5","h4","h3","h2","h1","h0","gZ","gY","gX"];q M=[0.0,1.gW,4.gV,6.gU,9.gT,10.gS,12.gR,14.gQ,15.9q,18.9q,20.gP,22.gO,24.gN,26.gM,28.gL,30.gK,32.gJ,35.gI,39.gH,39.gG,40.gF,44.gE,47.gD,50.gC,51.gB,54.gA,55.gz,58.gy,58.gx,63.gw,65.38,69.gv,72.64,74.gu,78.96,79.gs,83.gr,85.gq,87.62,88.gp,91.gn,92.gm,95.96,98,gl.gk,gj.gi,gh.42,gf.gd,gc.gb,ga.g9,g8.71,g7.76,g6.6,g5.g4,g3.g2,g1.g0,fZ.fY,fX.fW,9p.fV,9p.fU,fT.fS,fR,fQ.36,fP.fO,fN.25,fM.fL,fK.fJ,fI.fH,fG.9k,fF.fE,fD.fC,fB.fz,fy.49,fx.fw,fv.84,fu.9n,ft.23,9o.fs,9o.fr,fq.fp,fo.59,fm.fl,9n.2,fk.fj,9m,9m,fi,fh,fg,fe,fd.fc,fb.fa,f9.f8,f7,f6,f5,9l,9l,f4,f3,f2,f1,9k,9j,f0,9j,eZ,eY,eX,eW,eV,eU];q 7k=["eT","H","eS","eR","eQ","B","C","N","O","F","eP","eO","eN","eM","eL","P","S","eK","eJ","K","eI","eH","eG","V","eF","eD","eC","eB","eA","ez","ey","ew","ev","eu","et","es","er","ep","eo","Y","em","el","ek","9i","ej","ei","eh","eg","ef","ee","ed","ec","9i","I","ea","e9","e8","e7","e6","e5","e4","e3","e2","e1","e0","dZ","dY","dX","dW","dV","dU","dT","dS","dR","W","dQ","dP","dO","dN","dM","dL","dK","dJ","dI","dH","dG","dF","dE","dD","dC","dB","dA","U","dz","dw","dv","du","dt","dr","dq","dp","do","8O","dn","dm","dl","dk","dj","di","dh","dg","df"];1j(q 2u=0;2u<7k.17;2u++){1N[7k[2u]]=M[2u]}q 2l=1p.2l;q 2Q=1p.2Q;q 2U=1p.2U;q 6P=1p.2U;q 2Y=1p.2Y;q 1y=1p.1y;q 2V=1p.1y;q 3M=1p.3M;q 4J=1p.4J;q 4K=1p.4K;q 5A=1p.5A;q 5y=1p.5y;q 5z=1p.5z;q 4M=1p.4M;q 5x=1p.5x;q 4N=1p.4N;q 3L=1p.3L;q 4F=1p.4F;q 2O=1p.2O;q 1A=1p.1A;J de(n,x){D 1A(2l(x),n)}J dd(n,x){D 1A(2Q(x),n)}J dc(n,x){D 1A(2U(x),n)}J db(n,x){D 1A(45(x),n)}J da(n,x){D 1A(5B(x),n)}J d9(n,x){D 1A(4O(x),n)}J d8(n,x){D 1A(1y(x),n)}J d7(n,x){D 1A(2V(x),n)}J d6(b,v){D 2V(v)/2V(b)}J u(x){D(x>=0)?(x?1:0.5):(0)}J 4L(x){if(x==0){D 4e}D 0}J 6Q(x){D 2*u(x)-1}J d5(9h,9g,4f){if(9h){D 9g}D 4f}J 6S(x){if(x===0){D 1}D 2l(27*x)/(27*x)}J 5B(x){D 1/(2Q(x))}J 4O(x){D 1/(2l(x))}J 45(x){D 1/(2U(x))}q d4=45;q d3=45;q 6T=4O;q 7j=[1,1,2,5,15,52,d2,d1,d0,cZ,cY,cX,cW,cV,cU,cT,cS,cR,cQ,cP,cO,cN,cM];J 9e(x){if(x===0){D-0.5}R if(x==1){D 4e}R if(x==2){D 27*27/6}R if(x==4){D 27*27*27*27/90}R if(x<1){D 4e}q 1g=4.4*1A(x,-5.1);1j(q 5V=1;5V<10;5V++){1g+=1A(5V,-x)}D 1g}J 2T(x){if(x>1.0){D(2Y(x*(2V(x)-1)+0.5*(-2V(x)+9f)+1/ (12 * x) - 1 /(cL*(x*x*x))+1/ (cK * 1A(x, 5)) - 1 /(cJ*1A(x,7))))}if(x>-0.5){D(1.0+0.cI*x+0.cH*1A(x,2))/(x+0.cG*1A(x,2)-0.cF*1A(x,3))}if(x<0){if(x==~~x){D}R{D 1p.3Z/(1p.2l(1p.3Z*x)*2T((1-x)))}}R{D 1A(x-1,x-1)*1p.2O(2*1p.3Z*(x-1))*2Y(1-x+1/ (12 * (x - 1) + 2 /(5*(x-1)+53/(42*(x-1)))))}}J 7h(x){D 3L()}Γ=2T;ψ=7h;π=27;J 3d(ff){if(ff===0||ff==1){D 1}R if(ff>0&&ff==~~ff&&ff<15){q s=1;1j(q 5U=1;5U<=ff;5U++){s*=5U}D~~s}R if(ff!=(~~ff)||ff<0){D 2T(ff+1)}}J 6R(x){if(x==~~x&&x<7j.17){D 7j[x]}R{q 1g=0;1j(q 4U=0;4U<5;4U++){1g+=1A(4U,x)/3d(4U)}D 1g/e}}q 4i=0;J 7i(ia,5T,x){4i++;q 1x;if(4i>8){4i-=1;D 0}q h=0.7Y;if(5T>0){1x=(7i(ia,5T-1,x+h)-7i(ia,5T-1,x-h))/(2*h);4i-=1;D 1x}1x=g[ia](x);4i-=1;D 1x}q 4p={\'gt\':">","1k(":"(","1a)":")","1k[":"[","1a]":"]",\'ge\':">=",\'cE\':"<",\'cD\':"<=","cC":"∞","cB":"*","3t":"","cA":"\\\\","cw":"α","cv":"β",\'cu\':"γ",\'4L\':"δ",\'9e\':"ζ",\'ct\':"η",\'cs\':"θ",\'cr\':"ι",\'cq\':"κ",\'co\':"μ",\'cn\':"ν",\'cm\':"ξ",\'cl\':"ο",\'ck\':"ρ",\'cj\':"σ",\'ci\':"τ",\'ch\':"υ",\'cg\':"χ",\'7h\':"ψ",\'cf\':"ω",\'67\':"ϕ","ce":"φ","cd":"φ","cc":"ϵ","cb":"ε","ca":"ε","c9":"ς","c8":"ς","c7":"ϝ","c6":"ϝ","c5":"ϝ","c4":"ϰ","c3":"ϰ","c2":"ϖ","c1":"ϖ","c0":"ϱ","bZ":"ϱ","bY":"ϑ","bX":"ϑ","27":"π","6a":"λ",\'2T\':"Γ",\'bW\':"Δ",\'bV\':"Θ",\'bU\':"Λ",\'bT\':"Ξ",\'bS\':"Π",\'bR\':"Σ",\'bQ\':"Υ",\'bP\':"Φ",\'bO\':"Ψ",\'bN\':"Ω","bM":"⊥",",":" ","bL":"∇","bK":"∀","1g":"∑","bJ":"∑","bI":"∏","1h":"∏","bH":"∐","bG":"∐","bF":"∫","9d":"∫"};q 1t={};q L={"1h":1,"1g":2,"2P":3,"8P":4,"5P":5,"2L":6,"7b":7,"1O":8,"fn":9,"1Y":10,"8T":11,"9d":12,"6W":13,"8E":14};q 3p=0;J 3q(x){D x}q 3o="                     ";q 3b=0;J p(2S){if(1n 2S=="2P"||!2W(2S)){D 1B(2S)}R if(1n 2S=="21"){D 2S}if(2S==""||2S===1E){D 0}3q(!3p,0)||1W.1y(3o.1J(0,3b)+"p: "+2S);q eq=[];q e=2S.1z(/\\s/g,"").1z(/\\]/g,")").1z(/\\[/g,"(").1z(/\\)\\(/g,")*(");e=e.1z(/([^\\+\\-\\*\\/\\^\\:\\(\\)])\\(/g,"$1:(");e=e.1z(/\\)([^\\+\\-\\*\\/\\^\\:\\(\\)])/g,")*$1");if(e.1X("=")!=-1){q eq=e.1z("==","[3n][3n]").2F("=").8M(J(e){D e.1z("[3n][3n]","==")});if(eq.17==2){D[p(eq[0]),p(eq[1])].1q(L.6W)}1K("5O. \'=\' 8L 8K be 8J 8I 8H 4l.");D}2N((e.1X("(")!=-1)&&(e.1X(")")!=-1)){q 7g=1u;e=e.1z(/\\([^\\(\\)]*\\)/g,J(n){7g=1l;q h=5Z();1t[h]=p(n.1J(1,n.17-1));D"4g"+h+"4g"});if(7g){1K("8N 4a 5r bE");29}}q 1i=[];q 1S=0;q 9b="+-";q 99="*/";if(e.1X(",")!=-1){3q(!3p,0)||1W.1y(3o.1J(0,3b)+"f>: "+e);1i.Q=L.2L;q be=e.2F(",");be.2f(J(9c){1i.1c(p(9c))})}R if((e.1X("+")!=-1)||(e.1X("-")!=-1)){3q(!3p,0)||1W.1y(3o.1J(0,3b)+"+>: "+e);1i.Q=L.1g;q 3s=1l;1j(q i=0;i<e.17;i++){if(9b.1X(e[i])!=-1){q s=e.1J(1S,i);if(3s){1i.1c(p(s).2s(-1))}R{1i.1c(p(s))}if(e[i]=="-"){3s=1u}1S=i+1}}if(3s){1i.1c(p(e.1J(1S,e.17)).2s(-1))}R{1i.1c(p(e.1J(1S,e.17)))}}R if((e.1X("*")!=-1)||(e.1X("/")!=-1)){3q(!3p,0)||1W.1y(3o.1J(0,3b)+"*>: "+e);1i.Q=L.1h;q 4h=[];4h.Q=L.1h;q 3s=1l;1j(q i=0;i<e.17;i++){if(99.1X(e[i])!=-1){q s=e.1J(1S,i);if(3s){4h.1c(p(s))}R{1i.1c(p(s))}if(e[i]=="/"){3s=1u}1S=i+1}}if(3s){4h.1c(p(e.1J(1S,e.17)))}R{1i.1c(p(e.1J(1S,e.17)))}if(4h.17){1i=[1i,4h];1i.Q=L.1Y}}R if(e.1X("^")!=-1){3q(!3p,0)||1W.1y(3o.1J(0,3b)+"^>: "+e);q be=e.2F("^");if(be.17!=2){1K("^ is a 97 94");D}q 3r=p(be[0]);if(3r.Q==L.1h){1i.Q=L.1h;3r[3r.17-1]=[3r[3r.17-1],p(be[1])].1q(L.1O);1i.1c(3r)}R{1i.Q=L.1O;1i.1c(3r);1i.1c(p(be[1]))}}R if(e.1X(":")!=-1){3q(!3p,0)||1W.1y(3o.1J(0,3b)+"f>: "+e);1i.Q=L.fn;q be=e.2F(":");if(be.17!=2){1K("bD bC is a 97 94");D}q 3f=/^bB([\\d\\.\\+\\-e]+)$/(be[0]);if(3f){q 93=["1y",p(be[1])].1q(L.fn);1i.Q=L.1Y;1i.1c(93);1i.1c(["1y",p(3f[1])].1q(L.fn))}R{1i.1c(p(be[0]));1i.1c(p(be[1]))}}R if(e.1X("!")!=-1){1i.Q=L.1h;q 1S=0;1j(q i=0;i<e.17;i++){if(e[i]=="!"){q s=e.1J(1S,i);if(s==""){1i[1i.17-1]=["3d",1i[1i.17-1]].1q(L.fn)}R{1i.1c(["3d",p(s)].1q(L.fn))}1S=i+1}}q 7f=e.1J(1S,e.17);if(7f!=""){1i.1c(p(7f))}}R{q 7e=3N;if(!2W(7e=1B(e))){D 7e}R if(!/^4g[a-z\\d]{20}4g$/.2i(e)){q 3f=/^([\\d](\\.[\\d])?)([^\\d]+)$/(e);if(3f){1i.Q=L.1h;1i.1c(p(3f[1]));1i.1c(3f[3])}R{q 7d=e.2F(".");if(7d.17>1){1i.Q=L.1h;7d.2f(J(v){1i.1c(p(v))})}R{if(0&&e.17>1&&e[0]=="d"){1i.Q=L.1h;1i.1c("d");1i.1c(p(e.1J(1)))}R{D e;1i.Q=L.5P;1i.1c(e)}}}}R{1i.Q=L.5P;1i.1c(e)}}1i=1i.1M(/^4g[a-z\\d]{20}4g$/,J(e){q 8Z=1t[e.1J(4,24)];5i 1t[e.1J(4,24)];D 8Z});3q(!3p,0)||1W.1y(3o.1J(0,3b)+"@>: "+2Z.5t(1i));3b--;D 1i}J bA(fn){if((fn!==1E)&&(1n fn=="J")){q 1f=J(x){D A};1f.Q=L.7b;1f.f=fn;D 1f}R{q 1f=[];1f.Q=L.2L;1j(q i=0;i<8Y.17;i++){1f.1c(p(8Y[i]))}D 1f}};1s.19.bz=J(){};1s.19.im=J(){};1s.19.by=J(o){if(o.Q!=L.2L||A.Q!=L.2L){1K("I 8X it is 4a a 8W!")}};1s.19.7a=J(o){if(o.Q!=L.2L||A.Q!=L.2L){1K("I 8X it is 4a a 8W!")}q s=[];s.Q=L.1g;q 8V=4N(o.17,A.17);1j(q i=0;i<8V;i++){s.1H(A[i].2s(o[i]))}D s};1s.19.bx=J(){if(A.Q==L.2L){D A.7a(A.7c()).1A((0.5))}R{D A.2s(A.7c()).1A((0.5))}};1s.19.7c=J(){D A;D A.1M(/i/g,p("-i"))};1B.19.2R=J(x){D A==x};1D.19.2R=J(x){D A==x};1s.19.2R=J(x){q 3D=1l;1j(q i=0;i<A.17;i++){if(A[i].2R(x)){D 1u}}D 1l};1D.19.1M=J(a,b){if(a.2i&&a.2i(A.1m())){D b}if(A.1m()===a){D b}D A.1m()};1B.19.1M=J(a,b){if(A===a){D b}D A};1s.19.1M=J(a,b){q cp=[];A.2f(J(i){if(1n i=="1V"){if(a.2i){if(a.2i(i)){if(1n b=="J"){cp.1c(b(i))}R{cp.1c(b.1M(a,b))}}R{cp.1c(i)}}R{if(1n a=="1V"){cp.1c(i.1M(a,b))}}}R{cp.1c(i.1M(a,b))}});cp.Q=A.Q;D cp};1B.19.3O=J(o){q 1h=[A,p(o)];1h.Q=L.1Y;D 1h};1D.19.3O=J(o){q 1h=[];1h.Q=L.1Y;1h.1c(p(A.1m()));1h.1c(p(o));D 1h};1s.19.3O=J(o){if(A.Q==L.1Y){A[1].2s(p(o));D A}q 1h=[A,p(o)];1h.Q=L.1Y;D 1h};1s.19.1O=J(o){if(A.Q==L.1O){A[1]=A[1].2s(p(o))}D[A,p(o)].1q(L.1O)};1D.19.1O=J(o){D[p(A.1m()),p(o)].1q(L.1O)};1B.19.1O=J(o){D[A,p(o)].1q(L.1O)};1s.19.2s=J(o){if(A.Q==L.1Y){A[0].2s(p(o))}q 4f=p(o);if(4f.1F()===0){D 0}if(A.Q==L.1h&&4f.Q==L.1h){q 1f=A;4f.2f(J(e){1f.1c(e)});D A}R if(A.Q==L.2L||A.Q==L.7b){D 1f.7a(o)}q 1g=[A,o];q 5S=A.Q;A.1c(A.2t(0,A.17));A[0].Q=5S;A.1c(p(o));A.Q=L.1h;D A};1D.19.2f=J(e){e(A)};1B.19.2f=J(e){e(A)};1D.19.1H=J(o){if(o==0){D A.1m()}if(A.1m()=="0"){D p(o)}D[p(A.1m())].1q(L.1g).1H(p(o))};1B.19.1H=J(o){if(p(o).1F()==0){D A}q 1g=[p(A),p(o)];1g.Q=L.1g;D 1g};1B.19.1F=J(o){D A};1D.19.1F=J(){if(A.1m()=="i"){D"i"}if(!2W(A.1m())){D 1B(A.1m())}if(1N[A.1m()]){D 1F(A.1m())}D 3N};1s.19.1F=J(){if(A.2q()){D 1F(A.2z(1,1))}R{D 3N}};1D.19.2s=J(o){if(A.1m=="i"){D-1}if(o==1){D p(A.1m())}if(o==0){D 0}q 1g=[p(A.1m()),p(o)];1g.Q=L.1h;D 1g};1B.19.2s=J(o){if(A==0){if(p(o)==4e){D 1E}D 0}if(o==1){D A}if(o==0){D 0}q 1g=[p(A),p(o)];1g.Q=L.1h;D 1g};1s.19.1H=J(o){if(A.Q==L.1g&&o.Q==L.1g){q 1f=A;p(o).2f(J(e){1f.1c(e)});D A}if(A.Q==L.1g){A.1c(p(o));D A}q 1g=[A,o];q 5S=A.Q;A.1c(A.2t(0,A.17));A[0].Q=5S;A.1c(p(o));A.Q=L.1g;D A};1s.19.77=J(){q 4T=0;1j(q i=0;i<A.17;i++){if(1n A[i]=="1V"){4T+=A[i].17+6}R if(1n A[i]=="2P"){4T+=5}R{4T+=A[i].77?4+A[i].77():A[i].17}}D 4T};1D.19.5Q=J(2D){if(2D==L.1g){D"-"+A}R if(2D==L.1g){D(1).3O(A)}R if(2D===1E){1K("8U 4a bw")}};1s.19.5Q=J(2D){q 3P=[];q 5R=1l;3P.Q=A.Q||L.1g;if(2D==L.1g){if(3P.Q==L.1g){5R=1u}R if(3P.Q==L.1h){5R-1l}}q 75=1u;A.2f(J(e){if(5R||75){3P.1c(e.5Q(2D));75=1l}R{3P.1c(2D)}});D 3P};1B.19.5Q=J(2D){if(2D==L.1g){D-A}R if(2D==L.1h){D 1/A}R{1K("8D 8U: "+2D)}};1s.19.1q=J(e){A.Q=e;D A};1B.19.2k=J(){if(A==4e||A==-4e){D 1E}D 0};1D.19.2k=J(){D 1B(A.1m()=="x")};1s.19.2k=J(2M){2M=2M||1;if(2M<0){D A.70(-2M)}q 4d=[];4d.Q=L.1g;if(A.2q&&A.2q()){D 0}if(A.Q==L.1g){A.2f(J(e){4d.1H(e.2k())})}R if(A.Q==L.fn){q 73;if(73=8x[A[0]]){D[73.1M(/^x$/g,A[1]),A[1].2k()].1q(L.1h).1G()}R{1K("I bv\'t bu 8S 8T bt 8S "+A[0]+" J!")}D}R if(A.Q==L.1Y){q a=A[0];q b=A[1];D[[[a.2k(),b].1q(L.1h),[-1,b.2k(),a].1q(L.1h)].1q(L.1g),[b,b].1q(L.1h)].1q(L.1Y).1G();}R if(A.Q==L.1O){q a=A[0];q b=A[1];D[[a.2k(),[a,[b,-1].1q(L.1g)].1q(L.1O),b].1q(L.1h),[["1y",a].1q(L.fn),b.2k(),[a,b].1q(L.1O)].1q(L.1h)].1q(L.1g).1G()}R if(A.Q==L.1h){q a=A[0];q b=A.5q(1).1q(L.1h);D[[a,b.2k()].1q(L.1h),[b,a.2k()].1q(L.1h)].1q(L.1g).1G()}R{1K("5O 8R 8Q: "+A.Q);D}D 4d.1G()};1s.19.70=J(2M){2M=2M||1;if(2M<0){D A.2k(-2M)}q 4d=[];4d.Q=1g;q m;if(A.Q!=L.1g){m=p(0);m.Q=L.1g;m.1H(A)}R if(A.Q==L.1g){m=A}R{1K("5O 8R 8Q: "+A.Q)}m.2f(J(e){m.1c(e.70(2M))});D m};1D.19.6X=J(){D A.1m()};1D.19.4P=J(){D A.1m()};1B.19.4P=J(){D A};1s.19.4P=J(){D A;q 1a;if(A.Q!=L.1g){6c("?");1a=[].1q(L.1g).1H(1a)}R{1a=A}q 3a=[];q 4Q=[];4Q.Q=L.1g;q 4R=[];1j(q i=0;i<1a.17;i++){q 4c=0;q 4S;1j(q b=0;b<3a.17;b++){if(3a[b].2z()==1a[i].2z()){4S=b;4c=1;29}R if(1a[i].Q==L.1h&&1a[i].17==2){if(1a[i][0]==3a[b]){4S=b;4c=1a[i][1];29}R if(1a[i][1]==3a[b]){4S=b;4c=1a[i][0];29}}}if(4c!==0){4R[4S].1H(4c)}R{4R.1c([1].1q(L.1g));3a.1c(1a[i])}}1j(q i=0;i<3a.17;i++){if(4R[i]==1){4Q.1H(3a[i])}R{4Q.1H(3a[i].2s(4R[i]))}}D 4Q};1s.19.bs=1s.19.4P;1s.19.6X=J(){q 6Z=0;if(A.Q==L.8P||A.Q==L.2P){D}R if(A.Q==L.5P){D A}if(!A.2R("x")){1K("8O \'x\' 3D in "+A);D}q 1a=[];if(A.Q==L.1Y){1a.Q=L.1h;1a.1c(A[0].1M(/^x$/g,"y"));1a.1c(p(1).3O(A[1].1M(/^x$/g,"y")))}R{1a=A.1M(/^x$/g,"y")}q 1k=[p("x")];1k.Q=1a.Q;2N(1){6Z++;if(1a.Q==L.1h){q 4b=1l;1j(q i=0;i<1a.17;i++){if(!1a[i].2R("y")){4b=1u;1k=1k.3O(1a.2t(i,1).1q(L.1h));i--}}if(!4b){1a=1a.br("x")}}R if(1a.Q==L.1g){q 4b=1l;1j(q i=0;i<1a.17;i++){if(!1a[i].2R("y")){4b=1u;1k=1k.1H(1a.2t(i,1).1q(L.1g).2s(-1));i--}}if(!4b){1a=1a.4P()}}R if(1a.Q==L.1O){if(1a[0].2R("y")){1k=p("l^(1/b)").1M(/l/g,1k).1M(/b/g,1a[1]);1a=1a[0]}R{1k=p("1y(x)").1M(/^x$/g,1k);1k=1k.3O(p("1y(x)").1M(/^x$/g,1a[0]));1a=1a[1]}}R{D"1a.Q is bq R: "+1a.Q+": "+1a}2N(1a.17==1){if(1a[0]=="y"){D 1k}1a=1a[0]}if(6Z>10){1K("8N 4a bp 1j y: "+1k+"="+1a);D}}D 1k};J 6Y(n){1j(q i in 4p){2N(i.17>1&&n.1X("\\\\"+i)!=-1){n=n.1z("\\\\"+i,4p[i])}}D n.1z(/6l\\{([^\\}\\{]+)\\}/g,"6l$1").1z(/\\}\\{/g,")/(").1z(/\\}/g,"))").1z(/\\{/g,"((").1z(/\\\\/g,"")}J 7F(n){D p(6Y(n)).1G()}J 60(n){n=6Y(n);1t={};q eq=n.1z("==","[3n][3n]").2F("=").8M(J(e){D e.1z("[3n][3n]","==")});if(eq.17>2){1K("5O. \'=\' 8L 8K be 8J 8I 8H 4l.");D}q 5N,5M;if(eq.17==2){5N=p(eq[0]);q 8G=(5N.1M(/y/g,"x")).6X();5M=(8G.1M(/^x$/g,p(eq[1]))).go()}R{5N=p("y");5M=p(eq[0]).go()}q 5K={"f":J(){1K("bo a J")}};q 5L=5M.2z(0,1u);5K.f=1F("("+"J(x){D "+5L+";})");5K.3R=1F("(J(1d){1d.3J();q x=3Y;1d.3h(x,"+5L+");1j(q x=3Y;x<4E;x+=(4E-3Y)/3l){"+"1d.3g(x,"+5L+");}1d.3I();})");D 5K}1D.19.5k=J(){q e=1b.1r("2c");e.1e(1b.1I(A.1m()));D e};1B.19.5k=J(){q e=1b.1r("2c");e.1e(1b.1I(A.1m()));D e};1s.19.5k=J(){q e=1b.1r("2c");e.1e(1b.1I(A.2z()));D e};1D.19.2q=J(){if(A.1m()=="e"){D 2}if(A.1m()=="π"){D 2}if(A[0]=="\\""&&A[A.17-1]=="\\""){D 1u}q 8F=!2W(A.1m());if(!8F){if(!1N[A.1m()]){D 1l}}R{1W.bn("1B in 1V: "+A.1m())}D 1u};1B.19.2q=J(){D 1u};1s.19.2q=J(){1j(q i=0;i<A.17;i++){if(1n A[i]=="2P"){}R if(A[i].2q){q 1x;if(!(1x=A[i].2q())){D 1x}}R if(1n A[i]=="21"){if(!A[i]==3N&&2W(A[i])){D 1l}}}D 1u};1D.19.1G=J(){D A.1m()};1B.19.1G=J(){D A};1B.19.go=J(){D A};1D.19.go=J(){D A.1m()};1D.19.2g=J(x){D 1B(A.1m()==x)};1B.19.2g=J(x){D 1l};1s.19.2g=J(x){q 1x=[].1q(L.1g);if(A.Q==L.1Y){1x=1x.1H(A[0].2g(x));1x=1x.1H(A[1].2g(x))}R if(A.Q==L.1O){1x=1x.1H(A[0].2g(x).2s(A[1]))}R if(A.Q==L.fn){D 3N}R if(A.Q==L.1h){1j(q i=0;i<A.17;i++){1x=1x.1H(A[i].2g(x))}}R{D 3N}D 1x.1F()||1x.1G()};1s.19.5H=J(){q 1f=A.1G();if(A.Q==L.1Y){q ds=0;q 5J=0;if(ds=1f[0].2g("d")){if(5J=1f[1].2g("dx")){D(ds==5J)?(5J):3N}}D 1l}R if(A.Q==L.1h){q 5I=[].1q(L.1g);A.2f(J(f){5I.1c(f.5H())});D 5I.1F()||5I.1G()}D 1l;if(1f.Q==L.1Y){q 1x;if((1x=(1f[0].2g("d")*(1f[1].2g("dx"))))&&!1f.2R("x")){D 1x}if((1x=(1f[0].2g("dx")*(1f[1].2g("d"))))&&!1f.2R("x")){D-1x}}D 1l};1s.19.go=J(){q 1f=A.1G();if(1f.Q==L.1h){q 5G=1l;1j(q i=0;i<1f.17;i++){q 1x;if(1f[i].5H&&(1x=1f[i].5H())){5G=1x;1f.2t(i,1);i--;29}}if(5G==1){D A.1G().2k()}R if(5G==-1){D 1E}}if(1f.Q==L.1Y){if(1f[0].2g("d")==1&&1f[1].2g("dx")==1){D 1f.1M(/^d$/g,1).1M(/^dx$/g,1).1G().2k()}}1j(q i=0;i<1f.17;i++){if(1f[i].go){1f[i]=1f[i].go()}}D 1f};1s.19.1G=J(){if(A.2q&&A.2q()===1u){D A.1F()}if(A.Q==L.fn){A[1]=A[1].1G();if(A[0]=="1y"&&A[1]=="e"){D 1}D A}if(A.Q==L.1Y){A[0]=A[0].1G();A[1]=A[1].1G()}if(A.Q==L.1O){A[1]=A[1].1G();if(A[1].1F()===1){D A[0]}A[0]=A[0].1G();D A}1j(q i=0;i<A.17;i++){2N(((1n e[i])=="21")&&A[i].17==1){A[i]=A[i][0]}if(A[i].2q&&A[i].2q()===1u){A[i]=A[i].1F()}R{A[i]=A[i].1G()}}if(A.Q==L.1h){q 37=1;1j(q i=0;i<A.17;i++){q N=A[i].1F();if(!2W(N)){37*=N;A.2t(i,1);i--}}if(37!=1){A.1c(37)}if(37==0){D 0}q 5F=[];1j(q i=0;i<A.17;i++){if((1n A[i]=="21")&&A[i].Q==L.1h){5F.1c(A.2t(i,1)[0]);i--}}if(5F.17){q 1f=A;5F.2f(J(ff){2N(1n ff=="21"&&ff.17==1){ff=ff[0]}ff.2f(J(gg){2N(1n gg=="21"&&gg.17==1){ff=ff[0]}1f.1c(gg)})});D 1f}}R if(A.Q==L.1g){q 37=0;1j(q i=0;i<A.17;i++){q N=A[i].1F();if(!2W(N)){37+=N;A.2t(i,1);i--}}if(37!==0){A.1c(37)}}q z=A;2N(1n z=="21"&&z.17==1){z=z[0]}D z};1D.19.2z=J(){D A.1m()};1B.19.2z=J(){D A.1m()};J 2J(e){D e.1m()}q 6U="2l,2Q,2U,5B,45,4O,6T,1y,2Y,1A,2T,6S,2O,W,3d,6R,8B,u,6Q,4K,4J,5A,8A,8z,8y,6P,2V,3M,4M,4F,5z,5y,3L,4N,5x,3w,2J,6O,4L".2F(",");1s.19.2z=J(5C,48){q s=5C?"(":"";q 1f=A;q 5E=1u;q 46="";q 5D="";q 6V=1u;A.2f(J(e){if(!5E){6V=1l}if(5E){if(48&&1f.Q==L.1O){s+="1A(";46=")"}if(!48&&1f.Q==L.8E){s+="±"}R if(5C&&1f.Q==L.2L){s+="[";46="]"}R if(1f.Q==L.fn){if(1n e!="1V"&&1n e!="J"){1K("J bm is 4a a 1V: "+e);D"8C"}if(6U.1X(e)==-1){1K("8D J: "+e);D"8C"}5D="(";46=")"}5E=1l}R if(1f.Q==L.1g){s+="+"}R if(1f.Q==L.1h){s+="*"}R if(48&&1f.Q==L.1O){s+=","}R if(1f.Q==L.6W){s+="="}R if(1f.Q==L.1O){s+="^"}R if(1f.Q==L.1Y){s+="/"}R if(1f.Q==L.fn){if(6V){s+=","}}R{s+=","}if(e.Q==L.2L){s+=e.2z(0,48)}R{s+=e.2z(10,48)}s+=5D;5D=""});s+=46;46="";if(5C){s+=")"}D(s.1z(/(\\-\\-)+/g,"+").1z(/\\+\\++/g,"+").1z(/\\-\\+/g,"-").1z(/\\+\\-/g,"-"))};6U="2l,2Q,2U,5B,45,4O,6T,1y,2Y,1A,2T,6S,2O,W,3d,6R,8B,u,6Q,4K,4J,5A,8A,8z,8y,6P,2V,3M,4M,4F,5z,5y,3L,4N,5x,3w,2J,6O,4L,Γ,ψ".2F(",");1N.bl=33;q 8x={"1y":p("1/x"),"2l":p("2Q(x)"),"2Q":p("-2l(x)"),"2U":p("1/(2Q(x)*2Q(x))"),"2Y":p("2Y(x)"),"4M":p("6O(x)"),"u":p("4L(x)"),"2O":p("(x^(-1/2))*0.5"),"4K":p("1/2O(1-x^2)"),"4J":p("-1/2O(1-x^2)"),"3d":p("Γ(x+1)*ψ(x+1)"),"2T":p("Γ(x)*ψ(x)"),"Γ":p("Γ(x)*ψ(x)")};p("(3L(x)-0.5)");if(!A.2Z){A.2Z={}}(J(){J f(n){D n<10?\'0\'+n:n}if(1n 8w.19.3K!==\'J\'){8w.19.3K=J(31){D 8e(A.8v())?A.bk()+\'-\'+f(A.bj()+1)+\'-\'+f(A.bi())+\'T\'+f(A.bh())+\':\'+f(A.bg())+\':\'+f(A.bf())+\'Z\':2E};1D.19.3K=1B.19.3K=bd.19.3K=J(31){D A.8v()}}q cx=/[\\bc\\8u\\8t-\\8s\\8r\\8q\\8p\\8o-\\8n\\8m-\\8l\\8k-\\8j\\8i\\8h-\\8g]/g,5w=/[\\\\\\"\\bb-\\ba\\b9-\\b8\\8u\\8t-\\8s\\8r\\8q\\8p\\8o-\\8n\\8m-\\8l\\8k-\\8j\\8i\\8h-\\8g]/g,2j,4H,8f={\'\\b\':\'\\\\b\',\'\\t\':\'\\\\t\',\'\\n\':\'\\\\n\',\'\\f\':\'\\\\f\',\'\\r\':\'\\\\r\',\'"\':\'\\\\"\',\'\\\\\':\'\\\\\\\\\'},3m;J 5v(1V){5w.8c=0;D 5w.2i(1V)?\'"\'+1V.1z(5w,J(a){q c=8f[a];D 1n c===\'1V\'?c:\'\\\\u\'+(\'8b\'+a.8a(0).1m(16)).5q(-4)})+\'"\':\'"\'+1V+\'"\'}J 2H(31,41){q i,k,v,17,4I=2j,2K,1o=41[31];if(1o&&1n 1o===\'21\'&&1n 1o.3K===\'J\'){1o=1o.3K(31)}if(1n 3m===\'J\'){1o=3m.5s(41,31,1o)}6F(1n 1o){2r\'1V\':D 5v(1o);2r\'2P\':D 8e(1o)?1D(1o):\'2E\';2r\'6C\':2r\'2E\':D 1D(1o);2r\'21\':if(!1o){D\'2E\'}2j+=4H;2K=[];if(6N.19.1m.b7(1o)===\'[21 1s]\'){17=1o.17;1j(i=0;i<17;i+=1){2K[i]=2H(i,1o)||\'2E\'}v=2K.17===0?\'[]\':2j?\'[\\n\'+2j+2K.5u(\',\\n\'+2j)+\'\\n\'+4I+\']\':\'[\'+2K.5u(\',\')+\']\';2j=4I;D v}if(3m&&1n 3m===\'21\'){17=3m.17;1j(i=0;i<17;i+=1){k=3m[i];if(1n k===\'1V\'){v=2H(k,1o);if(v){2K.1c(5v(k)+(2j?\': \':\':\')+v)}}}}R{1j(k in 1o){if(6N.8d.5s(1o,k)){v=2H(k,1o);if(v){2K.1c(5v(k)+(2j?\': \':\':\')+v)}}}}v=2K.17===0?\'{}\':2j?\'{\\n\'+2j+2K.5u(\',\\n\'+2j)+\'\\n\'+4I+\'}\':\'{\'+2K.5u(\',\')+\'}\';2j=4I;D v}}if(1n 2Z.5t!==\'J\'){2Z.5t=J(1o,43,4G){q i;2j=\'\';4H=\'\';if(1n 4G===\'2P\'){1j(i=0;i<4G;i+=1){4H+=\' \'}}R if(1n 4G===\'1V\'){4H=4G}3m=43;if(43&&1n 43!==\'J\'&&(1n 43!==\'21\'||1n 43.17!==\'2P\')){1K 4Y b6(\'2Z.5t\')}D 2H(\'\',{\'\':1o})}}if(1n 2Z.5r!==\'J\'){2Z.5r=J(2J,6M){q j;J 6L(41,31){q k,v,1o=41[31];if(1o&&1n 1o===\'21\'){1j(k in 1o){if(6N.8d.5s(1o,k)){v=6L(1o,k);if(v!==1E){1o[k]=v}R{5i 1o[k]}}}}D 6M.5s(41,31,1o)}2J=1D(2J);cx.8c=0;if(cx.2i(2J)){2J=2J.1z(cx,J(a){D\'\\\\u\'+(\'8b\'+a.8a(0).1m(16)).5q(-4)})}if(/^[\\],:{}\\s]*$/.2i(2J.1z(/\\\\(?:["\\\\\\/b5]|u[0-9a-fA-F]{4})/g,\'@\').1z(/"[^"\\\\\\n\\r]*"|1u|1l|2E|-?\\d+(?:\\.\\d*)?(?:[eE][+\\-]?\\d+)?/g,\']\').1z(/(?:^|:|,)(?:\\s*\\[)+/g,\'\'))){j=1F(\'(\'+2J+\')\');D 1n 6M===\'J\'?6L({\'\':j},\'\'):j}1K 4Y b4(\'2Z.5r\')}}}());1s.19.4j=J(89){q 2u=A.1X(89);if(2u!==-1){A.2t(2u,1)}};1D.19.7T=J(){D A.b3(0).b2()+A.5q(1)};q 1v={};q 3Y=-10;q 4E=10;q 3z=10;q 3y=-10;q 3l,3k;1v.80={"3T":1.5};1v.1Z=(J(){q 4B=/[b1]eb[b0]it/.2i(4D.4C);q 2G;q 1d;q 3C,2v,5h;q 2w;J 6g(){3l=1N.6u||1b.2p.86;3k=1N.6t||1b.2p.82||81;2w.1Q.aZ=~~(3k-85)+"1R";1C.3l=3l;1C.3k=3k;1d&&2G()}q 2C=aY;q 2B=aX;q 5p=2C;q 5o=2B;q 4s;q 2a=64;q 2o=2a;q 1T;q 3H=0;q 3G=0;q cx=(1N.6u||1b.2p.86||aW)/-3;q cy=(1N.6t||1b.2p.82||81)*2/3;q cz=aV;J 2G(){e=1p.E;27=1p.3Z;if(!1d){D}1d.aU="aT";1d.6K=1d.7Z="aS";1d.aR(0,0,3l,3k);3Y=cx/2a;4E=(3l+cx)/2a;3y=-(3k-cy)/2o;3z=cy/2o;1T=1A(2,6-1p.4F(1y(2a)/1y(2)));q 3V=1T*~~(3Y/1T)-1T;q 3U=1T*~~(4E/1T)+1T;q 3W=1T*~~(3z/1T)+1T;q 3X=1T*~~(3y/1T)-1T;1d.3T=2;1d.3J();1d.3h(3V,0);1d.3g(3U,0);1d.3I();1d.3J();1d.3h(0,3X);1d.3g(0,3W);1d.3I();1d.6K="#aQ";1d.3T=0.1;1j(q x=3V;x<=3U;x+=1T/4){1d.3J();1d.3h(x,3X);1d.3g(x,3W);1d.3I()}1j(q y=3X;y<=3W;y+=1T/4){1d.3J();1d.3h(3V,y);1d.3g(3U,y);1d.3I()}1d.3T=0.4;1j(q x=3V;x<=3U;x+=1T){1d.3J();1d.3h(x,3X);1d.3g(x,3W);1d.3I()}1j(q y=3X;y<=3W;y+=1T){1d.3J();1d.3h(3V,y);1d.3g(3U,y);1d.3I()}1d.3T=1v.80.3T;1P.2f(J(e){if(!e.7S){1d.6K=1d.7Z=e.4X;e.3R(1d)}});}q 5m=0;J 7z(e){5p=2C=e.x||e.6J;5o=2B=e.y||e.6I;4s=1u;1C.1Q.6i="aP(6v.7L), 6v";if(!5m){6d(6H,6G);5m++}};J 6h(e){e=e||1N.3e;if(e.x!==1E){2C=e.x;2B=e.y}R{2C=e.6J;2B=e.6I}if(4s){3H+=2C-5p;3G+=2B-5o;if(4B){1C.1Q["-4B-7X"]="7W("+3H+"1R,"+3G+"1R)"}R{1C.1Q.1k=3H+"1R";1C.1Q.7U=3G+"1R"}}5p=2C;5o=2B};q 3S=0.aO;if(/aN/.2i(4D.4C)){3S=0.7Y}if(/aM/.2i(4D.4C)){3S=0.aL}if(/aK/.2i(4D.4C)){3S=0.aJ}if(!/aI aH X/.2i(4D.4C)){3S=0.1}J 5f(e){e=e||1N.3e;if(e.x!==1E){2C=e.x;2B=e.y}R{2C=e.6J;2B=e.6I}q ex=1p.2Y(e.aG*3S);2a*=ex;2o*=ex;q dx=2C+cx;q dy=2B-cy;if((dx*dx+dy*dy)>6G){cx=ex*(2C+cx)-2C;cy+=2B+ex*(cy-2B)-cy}2G()}J 6j(){cx-=3H;cy+=3G;3H=3G=0;if(4B){1C.1Q["-4B-7X"]="7W(7V,7V)"}R{1C.1Q.1k=3H+"1R";1C.1Q.7U=3G+"1R"}}J 6H(){if(4s){6j();2G();6d(6H,6G)}R{5m--}}J 6q(1t){q w=1b.1r("2X");w.2b="aF";q 3F=1n 1t;if(1t===2E){3F="1E"}if(3F=="J"&&1t.17!=1E&&1t[0]!=1E){3F="21"}3F=3F.1m();6F(3F){2r"2P":q fn=1b.1r("4z");fn.1e(1b.1I(1t));w.1e(fn);D w;29;2r"1V":q fn=1b.1r("2I");fn.1e(1b.1I("\\""+1t+"\\""));w.1e(fn);D w;29;2r"6C":w.1e(1b.1I(1t));D w;29;2r"1E":2r"J":q fn=1b.1r("i");if(1t===1E){fn.1e(1b.1I("1E"))}R if(1t===2E){fn.1e(1b.1I("2E"))}R{fn.1e(1b.1I(1t.1m()))}w.1e(fn);D w;29;2r"21":q 3D=1l;J 6B(i){q 1w=1b.1r("1w");q 3E=1n 1t[i];if(1t[i]===2E||1t[i]===1E){3E="1E"}6F(3E){2r"J":2r"21":q b=1b.1r("b");b.1e(1b.1I(i+": "));q 2c=1b.1r("2c");2c.1e(b);2c.1e(1b.1I((1n(1t[i])).7T()));1w.1e(2c);1w.1t=1t[i];q 6E=1b.1r("2c");6E.2b="6b";1w.1e(6E);1w.6D=1l;1w.2b="5b";1w.2y("aE",J(e){e.4r();if(A.2b=="5c"){A.2b="5b";D}A.2b="5c";if(!A.6D){A.6A("6b")[0].1e(6q(A.1t));A.6D=1u}D 1l},1l);29;5g:q b=1b.1r("b");1w.2b="aD";b.1e(1b.1I(i+": "));1w.1e(b);q 2H=1t[i];if(3E=="1E"){q 2I=1b.1r("i");2I.1e(1b.1I(2H));1w.1e(2I)}R if(3E=="6C"){1w.1e(1b.1I(2H))}R if(3E=="1V"){q 2I=1b.1r("2I");2I.1e(1b.1I("\\""+2H+"\\""));1w.1e(2I)}R if(3E=="2P"){q 2I=1b.1r("4z");2I.1e(1b.1I(2H));1w.1e(2I)}R{1w.1e(1b.1I(2H))}}w.1e(1w)}if(1t.aC!=1s.19){1j(i in 1t){3D=1u;6B(i)}}if(!3D){if(1t.17!==1E){1j(q i=0;i<1t.17;i++){3D=1u;6B(i)}if(!3D){w.1e(1b.1I(1t));D w}}R{w.1e(1b.1I(1t));D w}}29;5g:}D w}q 2X;q 1Z={"4j":J(n){if(!2X){2X=1b.6r("1P")}2X.4Z(n)},"3Q":J(){1N.7w=1C.aB("aA/3Q")},"1H":J(n){q 1w=5h.7A(1u);1w.id="eq-"+n.3u;if(!2X){2X=1b.6r("1P")}2X.1e(1w);q 2A=1w.6A("7B")[0];q 6y=1w.3v;q 6z=1w.3v.3v;q 7R=1w.6A("5i")[0];2A.1e(1b.1I(n.4l||""));6z.2y("az",J(e){1j(q i=0;i<1P.17;i++){if(1P[i].3u==n.3u){1P[i].7S=!6z.6o;2G();29}}},1l);2A.2y("4t",J(e){e.4r()},1l);6y.1Q.7D=n.4X;6y.2y("4t",J(e){e.4r()},1l);7R.2y("4t",J(e){1v.4j(1w);e.4r()},1l);1w.2y("4t",J(e){$(2A).6w({Q:"5l",7Q:1u,4A:65});$(2A).6w({Q:"5l",4A:39});2A.7P("7O")[0].7N()},1l);$(2A).3j("7H");$(2A).3j("7G");2A.ay=J(){1j(q i=0;i<1P.17;i++){if(1P[i].3u==n.3u){q 6x=$(2A).3j("3c");q c=60(6x);1P[i].f=c.f;1P[i].3R=c.3R;1P[i].4l=6x;2G();29}}};if(!n.4k){$(2A).6w({Q:"5l",7Q:1u,4A:65});2A.7P("7O")[0].7N()}D 1w},"5X":{"5W":("#7M,#ax,#aw,#7M,#av,#au,#at,#as,#ar,#aq,#ap,#ao,#an,#7C".2F(",")),},"7n":J(){if(2G){2G()}},"4W":J(){q 7K=1N.7v.17?1l:1u;(4Y am()).al="6v.7L";1C=1b.1r("1C");if(7K){1C.3l=1N.6u;1C.3k=1N.6t}1b.2p.1e(1C);if(1C.7J){1d=1C.7J("2d")}R{6c("ak!")}1C.1Q.aj="ai";1C.1Q.6i="5g";1C.1Q.ah="ag";3C=1b.1r("2c");3C.id="3C";3C.2b="7I";3C.1e(1b.1I("(0,0)"));1b.2p.1e(3C);2v=1b.1r("2c");2v.id="2v";2v.2b="7E";2v.1Q.6f="6e";2w=1b.1r("2c");2w.id="2w";2w.2b="7I";q 6s=1b.1r("4z");6s.id="2h";2v.1e(2w);2v.1e(6s);1b.2p.1e(2v);q 2h=1b.6r("2h");$(2h).3j("7H");$(2h).3j("7G");2h.2y("5l",J(3e){if(3e.4A==13){2h.1S=$(2h).3j("3c");q 3B=7F(2h.1S).1G();if(3B.go){3B=3B.go()}if(!3B.2q()){2w.1e(((3B.2z().5k())))}R{2w.1e(6q(5a.1F(3B.2z(0,1))))}$(2h).3j("3c","")}R if(3e.4A==38&&3e.af){if(!/\\\\[a-z]*|[^\\s]/ig.2i(2h.1S)){2h.1S=" "}$(2h).3j("3c",2h.1S)}},1l);q 3A=1b.1r("2c");3A.2b="7E";3A.id="3A";q 6p=1b.1r("2X");6p.id="1P";3A.1e(6p);q 4v=1b.1r("1w");q 4y=1b.1r("2c");4y.2b="b";4y.1Q.7D="#7C";q 5j=1b.1r("4x");5j.Q="ae";5j.6o="6o";4y.1e(5j);q 6n=1b.1r("4z");6n.2b="7B";q 6m=1b.1r("4z");6m.2b="5i";4v.1e(4y);4v.1e(6n);4v.1e(6m);q 3i=1b.1r("2c");3i.2b="3i";q 1L=1b.1r("4x");1L.1o="+";1L.Q="4u";1L.6k=J(){1v.1H()};3i.1e(1L);q 1L=1b.1r("4x");1L.1o=">6l";1L.Q="4u";1L.6k=J(){1v.1W()};3i.1e(1L);q 1L=1b.1r("4x");1L.1o=".3Q";1L.Q="4u";1L.6k=J(){1v.3Q()};3i.1e(1L);q 4w=1b.1r("a");4w.ad="ac://5Y.ab/aa/";4w.a9="a8";q 1L=1b.1r("4x");1L.1o="";1L.1Q.a7="6e";1L.Q="4u";4w.1e(1L);3i.1e(4w);3A.1e(3i);1b.2p.1e(3A);5h=4v.7A(1u);5h.a6("id");1N.a5=6g;1C.a4=7z;1b.2p.2y("a3",J(e){if(e.4u){1W.1y(e)}},1l);1b.2p.2y("4t",J(){4s=1l;6j();1C.1Q.6i="5g";2G()},1l);1b.2p.2y("6h",6h,1l);1N.2y("5f",5f,1l);2v.2y("5f",J(e){e.4r()},1l);1b.2p.4Z(1b.2p.3v);1d.3h=J(1R,2m,7y){D 1d.5e(2a*1R-cx,cy-2o*2m);D;if(!2W(2m)){if(2m>3z*4){1d.5e(2a*(1R-cx),2o*(cy-3z*4));D}R if(2m<3y*4){1d.5e(2a*(1R-cx),2o*(cy-3y*4));D}1d.5e(2a*(1R+cx),2o*(-cy-2m))}};1d.3g=J(1R,2m,7y){D 1d.4q(2a*1R-cx,cy-2o*2m);1d.4q(2a*1R-cx,cy-2o*2m);D;if(!2W(2m)){if(2m>3z*4){1d.4q(2a*(1R-cx),2o*(cy-3z*4));D}R if(2m<3y*4){1d.4q(2a*(1R-cx),2o*(cy-3y*4));D}1d.4q(2a*(1R-cx),2o*(cy-2m))}};6g()}};q 5d=1l;1Z.1W={"5c":J(){2v.1Q.6f="a2";5d=1u},"3w":J(){2N(2w.3v){2w.4Z(2w.3v)}D"a1"},"5b":J(){2v.1Q.6f="6e";5d=1l},"7m":J(){if(!5d){D 1v.1Z.1W.5c()}1v.1Z.1W.5b()},"1y":J(){}};D 1Z})();J 3w(){D 1v.1Z.1W.3w()}q 5a=(J(){q 5a={"1F":J(d){D 1N.1F(d)},"3w":J(){D 1v.1Z.1W.3w()}};D 5a})();q 1P=[];J a0(3f,4o){if(4o==",")D"";if(4p[4o]!==1E)D 4p[4o];D 4o}J 9Z(3e){if(1N.7x){6d(J(){7x.9Y("9X",3e)},20)}};J 9W(z){q 57="1F,1b,1N,7w,9V,6c,9U,9T,A,7v,6b,9S,9R,9Q,2G,9P,9O,9N,9M,9L,1C".2F(",");1j(q 4n=0;4n<57.17;4n++){if(z.1X(57[4n])!=-1){1K("9K 9J: "+57[4n]);D}}D 1F(z)}66="x^2@3x@2e^{-x}@2x+3@\\\\6a=3@e^{-\\\\6a*x}@\\\\1k(0.5,0.5\\\\1a)@\\\\56{n=1}^{\\\\68}\\\\3t{\\\\2l\\\\1k(9I\\\\1a)}n@\\\\7u{1}^{4}x-n	m:9H@\\\\1k|x^2-4\\\\1a|+2@\\\\9G@x^{-2}@x!@\\\\2V x@\\\\56{n=1}^{\\\\68}\\\\3t{x^n}{n}@\\\\2l x@e^x:\\\\1k[−2,2\\\\1a]@\\\\2U\\\\1k(x\\\\1a)@\\\\1k(x+2\\\\1a)\\\\1k(x-3\\\\1a)^2	9F\\\\1k(0,2,2x\\\\1a)@\\\\1k(x-2\\\\1a)^2@\\\\56{n=1}^{\\\\68}\\\\3t{\\\\2l\\\\1k(\\\\1k(2n−1\\\\1a)x\\\\1a)}{2n−1}@\\\\7u{n=1}^5\\\\1k(x-n\\\\1a)@\\\\56{n=0}^5n@x^x@\\\\2T\\\\1k(x\\\\1a)@\\\\3t{x!}{3!-x}@x%3@\\\\1k(x>3\\\\1a)?2x:-3@\\\\3d\\\\1k(x\\\\1a)@\\\\3t\\\\67 x@\\\\1k(x>=0\\\\1a)?7t*G/\\\\1k(7s+9E\\\\1a)^2:1E@g\\\\1k[0\\\\1a]\'\\\\1k(2x\\\\1a)@g\\\\1k[0\\\\1a]\\\\1k(x\\\\1a)+1@\\\\2O x".2F("@");q 7r=0;J 7o(){D 66[(7r++)%66.17]}J 9D(7q){61=7q.9C;2u=0;4m=7p.3v;2N(4m!=2E){if(4m==61){29;2u++}4m=4m.9B}g.2t(2u,1);9A.1c(9z.2t(2u,1)[0]);7p.4Z(61);9y()};q 5Y=J(n){q 3c=n;q 4k=0;if(n){4k=1u}R{3c=7o()}q t=J(x){D A.f(x)};q c=60(3c);t.f=c.f;t.3R=c.3R;t.4l=3c;t.3u=5Z();t.4X=1v.1Z.5X.5W.9x();t.4k=4k;t.9w=1v.1Z.1H(t);D t};1v.9v="9u";1v.1H=J(n){1P.1c(4Y 5Y(n));1v.1Z.7n()};1v.3Q=J(){1v.1Z.3Q()};1v.1W=J(){1v.1Z.1W.7m()};1v.4j=J(n){if(1n n!="1V"){q id=n.id.1J(3);1v.1Z.4j(n);n=id}1j(q i=0;i<1P.17;i++){if(1P[i].3u==n){1v.1Z.5X.5W.1c(1P[i].4X);1P.2t(i,1);29}}};1v.4W=J(){1v.1Z.4W();1v.1H("\\\\3t{d}{dx}\\\\1k(e^x+x^3\\\\1a)")};1v.4W();',62,1187,'||||||||||||||||||||||||||var||||||||||this|||return||||||function||eqtype|||||type|else||||||||||||||||length||prototype|right|document|push|ctx|appendChild|self|sum|product|terms|for|left|false|toString|typeof|value|Math|setType|createElement|Array|obj|true|app|li|res|log|replace|pow|Number|canvas|String|undefined|eval|simplify|add|createTextNode|substring|throw|newfuncbtn|dreplace|window|power|graphs|style|px|last|gridsize|num|string|console|indexOf|fraction|ui||object||||||pi||break|scalex|className|div|||forEach|has|conin|test|gap|differentiate|sin|py||scaley|body|canEval|case|multiply|splice|index|con|logt||addEventListener|getString|inputbox|my|mx|operation|null|split|draw|str|strong|text|partial|discretevector|times|while|sqrt|number|cos|search|inp|Gamma|tan|ln|isNaN|ul|exp|JSON||key||||||_0|||_1|level|latex|fact|event|match|line|move|buttons|mathquill|height|width|rep|equals|spaces|__debug_parser|__debug|base|nextisinverse|frac|gid|firstChild|clear||boundbottom|boundtop|funcs|out|ptd|found|m2|mode|_2|_3|stroke|beginPath|toJSON|random|abs|NaN|divide|inv|png|plot|scaleconst|lineWidth|overright|overleft|overtop|overbottom|boundleft|PI||holder||dreplacer||cot|endchar||javascript||not|moved|fou_c|itg|Infinity|other|hash|denom|difflevel|remove|auto|equation|other_node|nau_g|submatch|latexchars|lineTo|stopPropagation|drag|mouseup|button|_4|alink|input|_5|span|which|webkit|userAgent|navigator|boundright|round|space|indent|mind|acos|asin|delta|floor|min|csc|factorise|nr|_6|fou_i|_7|inj|exponent|init|color|new|removeChild|||||||sum_|naughty|||usr|hide|show|_8|moveTo|mousewheel|default|proto|delete|_9|markup|keydown|drawwhiledrag_c||lmy|lmx|slice|parse|call|stringify|join|quote|escapable|max|atan2|ceil|atan|sec|braces|afterme|_10|newproducts|foundit|isDifferential|count|dxs|ret|jsc|rhs|lhs|Invalid|variable|invert|_11|oldtype|lvl|nns|npw|free|colors|graph|random_hash|compile|this_node|||||randfuncs|phi|infinity||lambda|child|alert|setTimeout|none|display|resize|mousemove|cursor|perform_translation|onclick|_|_12|_13|checked|_14|generateJSON|getElementById|conin_|innerHeight|innerWidth|grabbing|trigger|l__|b_|check_|getElementsByClassName|do_loop|boolean|done|children|switch|1000|drawwhiledrag|pageY|pageX|strokeStyle|walk|reviver|Object|shaw|tg|signum|bellb|sinc|cosec|functions|second|equality|inverse|clean|__debug_iterations|integrate|||fnd||first||size|||dot|continuousvector|conjg|vars|parsednumber|final|fail|psi|djkb|blln|symbol|digits|toggle|refresh|randfunc|flist|delete_button_node|randfunc_index|r_e|m_e|prod_|parent|location|pageTracker|pz|mousedown|cloneNode|matheditor|07c|backgroundColor|overlay|p_latex|redraw|editable|monospace|getContext|fullscreen|gif|f08|focus|textarea|getElementsByTagName|ctrlKey|delete_|disabled|capitalize|top|0px|translate|transform|0001|fillStyle|config|120|clientHeight||||clientWidth|||elem|charCodeAt|0000|lastIndex|hasOwnProperty|isFinite|meta|uffff|ufff0|ufeff|u206f|u2060|u202f|u2028|u200f|u200c|u17b5|u17b4|u070f|u0604|u0600|u00ad|valueOf|Date|known_derivatives|arctan|arccos|arcsin|Zeta|ERROR|Unknown|pm|isnum|inverselhs|per|once|used|only|can|map|Could|No|constant|Type|Expression|the|derivative|Operation|lowest|vector|or|arguments|to_ret||||fn_|operator|||binary||prod_op||term_op|zz|integral|zeta|log2pi|val|cond|Te|262|259|247|210|207|192|140|9994|6378100|toPrecision|exptext|bdf3c03|version|node|pop|save|colors_in_use|colorss|nextSibling|parentNode|delfunc|100000x|diff|frac1x|H_2SO_4|nx|Code|Unsafe|nextframe|calcnextframe|extrafunc|get2dfunction|getfunction|clip|xmlhttp|xml|prompt|comfirm|cookie|safeeval|Graph|_15|track|getlatexpart|Cleared|block|mouseover|onmousedown|onresize|removeAttribute|textDecoration|_16|target|about|tk|http|href|checkbox|shiftKey|fixed|position|white|background|Failed|src|Image|f00|0a0|04f|f0f|f80|0ff|808|088|880|80f|8f0|onchange|change|image|toDataURL|__proto__|end|click|json|wheelDeltaY|OS|Mac|03|Opera|01|Firefox|AppleWebKit|001|url|888|clearRect|black|butt|lineCap|10000|640|300|400|maxHeight|kK|Ww|toUpperCase|charAt|SyntaxError|bfnrt|Error|apply|x9f|x7f|x1f|x00|u0000|Boolean||getUTCSeconds|getUTCMinutes|getUTCHours|getUTCDate|getUTCMonth|getUTCFullYear|_17|name|warn|Not|solve|someting|expand|factorize|of|know|don|specified|mag|cross|re|Vector|log_|composition|Function|parentheses|int|coproduct|coprod|prod|summation|forall|nabla|perp|Omega|Psi|Phi|Upsilon|Sigma|Pi|Xi|Lambda|Theta|Delta|vartheta|thetav|varrho|rhov|varpi|piv|varkappa|kappav|digamma|Gammad|gammad|sigmav|sigmaf|varepsilon|epsiv|epsilon|varphi|phiv|omega|chi|upsilon|tau|sigma|rho|omicron|xi|nu|mu||kappa|iota|theta|eta|gamma|beta|alpha||||backslash|cdot|infty|le|lt|3245138289924575|7281333047988399|24425221666910216|150917639897307|1680|1260|360|4506715738447323|474869816156751|51724158235372|5832742205057|682076806159|82864869804|10480142147|1382958545|190899322|27644437|4213597|678570|115975|21147|4140|877|203|ctn|ctg|piecewise|logb|ln_n|log_n|csc_n|sec_n|cot_n|tan_n|cos_n|sin_n|Rg|Ds|Mt|Hs|Bh|Sg|Db|Rf|Lr|Md|Fm|Es|Cf||Bk|Cm|Am|Pu|||Np|Pa|Th|Ac|Ra|Fr|Rn|At|Po|Bi|Pb|Tl|Hg|Au|Pt|Ir|Os|Re|Ta|Hf|Lu|Yb|Tm|Er|Ho|Dy|Tb|Gd|Eu|Sm|Pm|Nd|Pr|Ce|La|Ba|Cs|Xe||Sb|Sn|In|Cd|Ag|Pd|Rh|Ru|Mo|Nb|Zr||Sr|Rb||Kr|Br|Se|As|Ge|Ga||Zn|Cu|Ni|Co|Fe|Mn||Cr|Ti|Sc|Ca|Ar|Cl|Si|Al|Mg|Na|Ne|Be|Li|He|Zero|272|271|268|277|264|266|261|258|257|252|251|243|244|237|02891|238|03588|231|03806|232|227||226|223|220|980401|208|3833|204||200|966569|196|084|217|190|186|183|94788|180|178|9668||174|054|173|93421|168|167|93032|164|5001|162|92535|158|157|964|151|150|145|242|144|90765|116|90547|138|327|137|9054519|132|293|131|90447|126|127|121|118|818|114|411|112|8682||107||106|9055|102|07|101|90638|224||90585|4678|798|904||9216|723|546|6934|933195|845|938045|9961|9415|867|955912|078|0983|948|453|065|973762|0855|9815386|305|98976928|1797|0067|0107|811|012182|941|002602|00794|Unununium|Ununnilium|Meitnerium|Hassium|Bohrium|Seaborgium|Dubnium|Rutherfordium|Lawrencium|Nobelium|Mendelevium|Fermium|Einsteinium|Californium|Berkelium|Curium|Americium|Plutonium|Neptunium|Uranium|Protactinium|Thorium|Actinium|Radium|Francium|Radon|Astatine|Polonium|Bismuth|Lead|Thallium|Hydrargyrum|Gold|Platinum|Iridium|Osmium|Rhenium|Tungsten|Tantalum|Hafnium|Lutetium|Ytterbium|Thulium|Erbium|Holmium|Dysprosium|Terbium|Gadolinium|Europium|Samarium|Promethium|Neodymium|Praseodymium|Cerium|Lanthanum|Barium|Cesium|Xenon|Iodine|Tellurium|Antimony|Tin|Indium|Cadmium|Silver|Palladium|Rhodium|Ruthenium|Technetium|Molybdaenum|Niobium|Zirkonium|Yttrium|Strontium|Rubidium||Krypton|Bromine||Selenium|||Arsenic|Germanium|Gallium|Zinc|Copper|||Nickel|Cobalt|Iron|Manganese|||Chromium|Vanadium|Titanium|Scandium|Calcium|Potassium|Argon|Chlorine|Sulphur|Phosphorus|Silicon|aluminium|Magnesium|Sodium|Neon|Fluorine|Oxygen|Nitrogen|Carbon|Boron|Beryllium|Lithium|Helium|Hydrogen|void|Massless|85418782e|epsilon_0|8378770664093453|626068e|R_E|98892e30|m_s|36e22|m_m|9742e24|67300e|299792458|0000000|0000001|format'.split('|'),0,{}))
